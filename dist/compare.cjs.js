...
var styled$4 = require('styled-components');
...
require('antd/es/comment/style');
var _Comment = require('antd/es/comment');
...
var styled__default = /*#__PURE__*/_interopDefaultLegacy(styled$4);
...
var GET_COMPARISON_DATA = 'GET_COMPARISON_DATA';
var GET_COMPARISON_DATA_SUCCESS = 'GET_COMPARISON_DATA_SUCCESS';
var GET_COMPARISON_DATA_FAILED = 'GET_COMPARISON_DATA_FAILED';
var GET_TEMPLATE_DATA = 'GET_TEMPLATE_DATA';
var GET_TEMPLATE_DATA_SUCCESS = 'GET_TEMPLATE_DATA_SUCCESS';
var GET_TEMPLATE_DATA_FAILED = 'GET_TEMPLATE_DATA_FAILED';
var SET_COMPARISON_DATA = 'SET_COMPARISON_DATA';
var CLEAR_COMPARISON_DATA = 'CLEAR_COMPARISON_DATA';
var SAVE_COMPARISON = 'SAVE_COMPARISON';
var SAVE_COMPARISON_SUCCESS = 'SAVE_COMPARISON_SUCCESS';
var SAVE_COMPARISON_FAILED = 'SAVE_COMPARISON_FAILED';
var CLOSE_NOTIFICATION = 'CLOSE_NOTIFICATION';
var RESET_STATE = 'RESET_STATE';
var SET_AUTHKEY = 'SET_AUTHKEY';
var UPDATE_SELECTED_PROPERTIES = 'UPDATE_SELECTED_PROPERTIES';
var UPDATE_SELECTED_PRODUCTS = 'UPDATE_SELECTED_PRODUCTS';
var DELETE_COMPARISON = 'DELETE_COMPARISON';
var DELETE_COMPARISON_FAILED = 'DELETE_COMPARISON_FAILED';
var DELTE_COMPARISON_SUCCESS = 'DELTE_COMPARISON_SUCCESS';
var REMOVE_COMPARE_ITEM = 'REMOVE_COMPARE_ITEM';
var CLEAR_COMPARISON = 'CLEAR_COMPARISON';
var SAVE_CURRENT_COMPARISON_ID = 'SAVE_CURRENT_COMPARISON_ID';
var HIGHLIGHT_DIFFERENCES = 'HIGHLIGHT_DIFFERENCES';
var SET_COMPARE_VIEW_VISIBLE = 'SET_COMPARE_VIEW_VISIBLE';
var GET_COMPARISON_MODAL_DATA = 'GET_COMPARISON_MODAL_DATA';
var GET_COMPARISON_MODAL_DATA_SUCCESS = 'GET_COMPARISON_MODAL_DATA_SUCCESS';
var GET_COMPARISON_MODAL_DATA_FAILED = 'GET_COMPARISON_MODAL_DATA_FAILED';
var COMPARE_VIEW_CANCEL = 'COMPARE_VIEW_CANCEL';
var UPDATE_SELECTED_PRODUCTS_FROM_MODAL = 'UPDATE_SELECTED_PRODUCTS_FROM_MODAL';
  ...
  switch (action.type) {
    case GET_COMPARISON_DATA:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        ...
        isComparisonChanged: action.isComparisonChanged,
        propertiesUpdated: false,
        currentItemKey: action.currentItemKey
      });

    case GET_COMPARISON_DATA_SUCCESS:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        values: action.values,
        apiUrls: action.apiUrls || {},
        compareModalValues: action.compareModalValues,
        loading: false,
        error: false,
        currentItemKey: action.nextItemKey,
        comparisonDataError: ''
      });

    case GET_COMPARISON_MODAL_DATA_SUCCESS:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        compareModalValues: action.compareModalValues,
        apiUrls: action.apiUrls,
        ...
        currentItemKey: action.nextItemKey,
        comparisonDataError: '',
        selectedProductsFromModal: action.selectedProductsFromModal,
    ...
    case GET_COMPARISON_DATA_FAILED:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        comparisonDataError: action.comparisonDataError,
        loading: false,
        currentItemKey: action.currentItemKey,
        inputValue: action.inputValue
      });

    case GET_COMPARISON_MODAL_DATA:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        loadingInModal: action.loadingInModal,
        currentItemKey: action.currentItemKey
      });

    case GET_COMPARISON_MODAL_DATA_FAILED:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        comparisonDataError: action.comparisonDataError,
        loadingInModal: false,
        currentItemKey: action.currentItemKey,
    ...
    case DELETE_COMPARISON_FAILED:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        alertErrorMsg: action.alertErrorMsg,
        currentComparisonId: action.currentComparisonId,
        loading: false
      });

    case DELTE_COMPARISON_SUCCESS:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        alertSuccessMsg: action.alertSuccessMsg,
        loading: false,
        currentComparisonId: action.currentComparisonId,
    ...
    case UPDATE_SELECTED_PROPERTIES:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        selectedProperties: action.selectedProperties,
        propertiesUpdated: action.propertiesUpdated
      });
    ...
    case SAVE_CURRENT_COMPARISON_ID:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        currentComparisonId: action.currentComparisonId,
        name: action.name
      });
    ...
    case HIGHLIGHT_DIFFERENCES:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        highlightSelected: action.highlightSelected
      });

    case SET_COMPARE_VIEW_VISIBLE:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        compareViewVisible: action.compareViewVisible,
        comparisonDataError: '',
        inputValueForError: ''
      });

    case COMPARE_VIEW_CANCEL:
      return _objectSpread2(_objectSpread2({}, state), {}, {
    ...
    case UPDATE_SELECTED_PRODUCTS_FROM_MODAL:
      return _objectSpread2(_objectSpread2({}, state), {}, {
        selectedProductsFromModal: action.selectedProductsFromModal
      });
...
var initialState = {
  ...
  propertiesUpdated: false,
  apiUrls: {},
  apiUrl: "".concat(process.env.REACT_APP_STORYBOOK_URL, "/productIAN1.json"),
...
var compareUrl = process.env.REACT_APP_COMPARE_SERVICE_URL;
...
var getTemplate = function getTemplate(templateId) {
  return callApi(GET, "".concat(compareUrl, "/api/template/").concat(templateId));
};

var getSavedComparison = function getSavedComparison(comparisonId) {
  var extraOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var url = "".concat(compareUrl, "/api/comparison/").concat(comparisonId);
  return callApi(GET, url, null, extraOptions);
};

var createComparison = function createComparison(payload) {
  var extraOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  return callApi(POST, "".concat(compareUrl, "/api/comparison"), payload, extraOptions);
};

var deleteComparisonById = function deleteComparisonById(id) {
  var extraOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  return callApi(DELETE, "".concat(compareUrl, "/api/comparison/").concat(id), null, extraOptions);
};

var fetchAllComparisons = function fetchAllComparisons() {
  var extraOptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  return callApi(GET, "".concat(compareUrl, "/api/fetch/comparisons"), null, extraOptions);
};
...
var CompareContext = /*#__PURE__*/React.createContext([{}, function () {}]);
var CompareContextProvider = function CompareContextProvider(props) {
  ...
  var getComparisonData = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, key, transformResponse) {
      var _yield$fetch, data, newState, transformedResponse, nextKey;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              transformedResponse = _context.sent;
            ...
            case 14:
              ...
              dispatch({
                type: GET_COMPARISON_DATA_SUCCESS,
                apiUrls: newState.apiUrls,
                values: newState.values,
                nextItemKey: nextKey,
                compareModalValues: JSON.parse(JSON.stringify(newState.values))
              });
              _context.next = 24;
              break;
            ...
            case 21:
              ...
              dispatch({
                type: GET_COMPARISON_DATA_FAILED,
                comparisonDataError: _context.t0.message
              });
    ...
    return function getComparisonData(_x, _x2, _x3) {
      return _ref.apply(this, arguments);
    };
  }();

  var getTemplateData = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(templateId) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              selectedProperties = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : {};
              fetchSavedComparisons = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : true;
              _context2.prev = 2;
              _context2.next = 5;
              return getTemplate(templateId);

            case 5:
              _yield$getTemplate = _context2.sent;
              data = _yield$getTemplate.data;
              _context2.t0 = fetchSavedComparisons;
              ...
              _context2.next = 11;
              return fetchAllComparisons(getAuthHeaders());
            ...
            case 12:
              ...
              sections = Object.keys(data.result.comparisonPanelProps);

              if (!Object.keys(selectedProperties).length) {
                sections.forEach(function (section) {
                  return selectedProperties[section] = _toConsumableArray(newState.comparisonPanelProps[section].options);
                });
              }
    ...
    return function getTemplateData(_x4) {
      return _ref2.apply(this, arguments);
    };
  }();

  var getSavedComparisonData = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(comparisonId, compareKey) {
      var _yield$getSavedCompar, data, newState, result, templateId, selectedProperties, selectedItems, apiUrls, nextItemKey, promises;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return getSavedComparison(comparisonId, getAuthHeaders());

            case 3:
              _yield$getSavedCompar = _context4.sent;
              data = _yield$getSavedCompar.data;
              newState = _objectSpread2({}, state);
              newState.values = {};
              result = data.result;
              templateId = result.templateId, selectedProperties = result.selectedProperties, selectedItems = result.selectedItems, apiUrls = result.apiUrls;
              getTemplateData(templateId, selectedProperties, false);
              promises = selectedItems.map( /*#__PURE__*/function () {
                var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(selectedItem, index) {
                  var _yield$fetch2, data;
                  ...
                  return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          _context3.next = 2;
                          return fetch(apiUrls && apiUrls[selectedItem] || newState.apiUrl);

                        case 2:
                          _yield$fetch2 = _context3.sent;
                          data = _yield$fetch2.data;
                          newState.values["".concat(compareKey, "_").concat(index + 1)] = data;
                          nextItemKey = "".concat(compareKey, "_").concat(index + 2);
    ...
    return function getSavedComparisonData(_x5, _x6) {
      return _ref4.apply(this, arguments);
    };
  }();

  var closeComparisonNotification = function closeComparisonNotification() {
    dispatch({
      type: CLOSE_NOTIFICATION
    });
  };

  var saveComparison = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(name, templateId) {
      var itemSelectorProp, selectedItems, payload, _yield$createComparis, data, result, savedComparisonKeys, savedComparisons, newsSavedComparisons, newSavedComparisonKeys, _data, errors, _errors, err, errorMesage;
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              itemSelectorProp = state.itemSelectorProp && state.itemSelectorProp.title.toLowerCase();
              selectedItems = Object.keys(state.values).map(function (key) {
              ...
              _context5.next = 6;
              return createComparison(payload, getAuthHeaders());

            case 6:
              _yield$createComparis = _context5.sent;
              data = _yield$createComparis.data;
              result = data.result;
              savedComparisonKeys = state.savedComparisonKeys, savedComparisons = state.savedComparisons; //add comparison to dropdown

              newsSavedComparisons = [].concat(_toConsumableArray(savedComparisons), [result]);
              newSavedComparisonKeys = savedComparisonKeys;
              newSavedComparisonKeys[result.id] = result;
              dispatch({
                type: SAVE_COMPARISON_SUCCESS,
                alertSuccessMsg: "".concat(result.name, " has been saved"),
            ...
            case 17:
              ...
              if (_context5.t0.response) {
                _data = _context5.t0.response.data;
                errors = _data.errors;
                _errors = _slicedToArray(errors, 1), err = _errors[0];
                errorMesage = err.message + "\n";
                err.errors.forEach(function (errorr) {
                  if (errorr.message) {
                    errorMesage += errorr.dataPath + " " + errorr.message + "\n";
                  }
                });
                dispatch({
                  type: SAVE_COMPARISON_FAILED,
                  alertErrorMsg: errorMesage
                });
              } else {
                dispatch({
                  type: SAVE_COMPARISON_FAILED,
                  alertErrorMsg: _context5.t0.message
                });
              }
    ...
    return function saveComparison(_x9, _x10) {
      return _ref6.apply(this, arguments);
    };
  }();

  var deleteComparison = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(currentComparisonId) {
      var _yield$deleteComparis, data, result, newState, _data2, errMsg;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.prev = 0;
              _context6.next = 3;
              return deleteComparisonById(currentComparisonId, getAuthHeaders());

            case 3:
              _yield$deleteComparis = _context6.sent;
              data = _yield$deleteComparis.data;
              result = data.result;
              newState = _objectSpread2({}, state);
              newState.savedComparisons = state.savedComparisons.filter(function (item) {
                return item.id !== currentComparisonId;
              });
              delete newState.savedComparisonKeys[currentComparisonId];
              dispatch({
                type: DELTE_COMPARISON_SUCCESS,
                alertSuccessMsg: "Comparison ".concat(result.name, " has been deleted"),
                currentComparisonId: "",
                savedComparisons: newState.savedComparisons,
                savedComparisonKeys: newState.savedComparisonKeys
              });
            ...
            case 14:
              ...
              _data2 = _context6.t0.response.data;

              if (_data2) {
                errMsg = getErrorResponseMessage(_data2);
                dispatch({
                  type: DELETE_COMPARISON_FAILED,
                  alertErrorMsg: errMsg
                });
              } else dispatch({
                type: DELETE_COMPARISON_FAILED,
                alertErrorMsg: _context6.t0.message
              });
    ...
    return function deleteComparison(_x11) {
      return _ref7.apply(this, arguments);
    };
  }();

  var clearComparison = function clearComparison() {
    var comparisonPanelProps = state.comparisonPanelProps,
        selectedProperties = state.selectedProperties;
    var newSelectedProperties = selectedProperties;
    var sections = Object.keys(comparisonPanelProps);
    sections.map(function (section) {
      return newSelectedProperties[section] = _toConsumableArray(comparisonPanelProps[section].options);
    });
    dispatch({
  ...
  var getErrorResponseMessage = function getErrorResponseMessage(data) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(CompareContext.Provider, {
    value: [state, dispatch, {
      getComparisonData: getComparisonData,
      getTemplateData: getTemplateData,
      getSavedComparisonData: getSavedComparisonData,
      saveComparison: saveComparison,
      closeComparisonNotification: closeComparisonNotification,
...
var HEX = themeGet.themeGet('colors.hex');
var LUP_BASE_BLUE_DARKER = themeGet.themeGet('colors.blue.800');
var LUP_BASE_BLUE_DARK = themeGet.themeGet('colors.blue.700');
var LUP_BASE_BLUE = themeGet.themeGet('colors.blue.500');
var LUP_BASE_BLUE_LIGHTER = themeGet.themeGet('colors.blue.200');
var LUP_BASE_BLUE_LIGHT = themeGet.themeGet('colors.blue.100');
var LUP_BASE_BLUE_LIGHTEST = themeGet.themeGet('colors.blue.50');
var LUP_BASE_GREY_DARKEST = themeGet.themeGet('colors.grey.800');
var LUP_BASE_GREY_DARKER = themeGet.themeGet('colors.grey.700');
var LUP_BASE_GREY_DARK = themeGet.themeGet('colors.grey.600');
var LUP_BASE_GREY_MEDIUM = themeGet.themeGet('colors.grey.500');
var LUP_BASE_GREY = themeGet.themeGet('colors.grey.400');
var LUP_BASE_GREY_LIGHT = themeGet.themeGet('colors.grey.300');
var LUP_BASE_GREY_LIGHTER = themeGet.themeGet('colors.grey.200');
var LUP_BASE_GREY_LIGHTEST = themeGet.themeGet('colors.grey.100');
var LUP_FUNCTIONAL_SUCCESS_GREEN_DARK = themeGet.themeGet('colors.green.800');
var LUP_FUNCTIONAL_SUCCESS_GREEN = themeGet.themeGet('colors.green.500');
var LUP_FUNCTIONAL_SUCCESS_GREEN_LIGHT = themeGet.themeGet('colors.green.200');
var LUP_FUNCTIONAL_SUCCESS_GREEN_LIGHTER = themeGet.themeGet('colors.green.100');
var LUP_FUNCTIONAL_SUCCESS_GREEN_LIGHTEST = themeGet.themeGet('colors.green.50');
var LUP_FUNCTIONAL_ALERT_YELLOW_DARK = themeGet.themeGet('colors.yellow.800');
var LUP_FUNCTIONAL_ALERT_YELLOW = themeGet.themeGet('colors.yellow.500');
var LUP_FUNCTIONAL_ALERT_YELLOW_LIGHT = themeGet.themeGet('colors.yellow.200');
var LUP_FUNCTIONAL_ALERT_YELLOW_LIGHTER = themeGet.themeGet('colors.yellow.100');
var LUP_FUNCTIONAL_ALERT_YELLOW_LIGHTEST = themeGet.themeGet('colors.yellow.50');
var LUP_FUNCTIONAL_ERROR_RED_DARK = themeGet.themeGet('colors.red.800');
var LUP_FUNCTIONAL_ERROR_RED = themeGet.themeGet('colors.red.500');
var LUP_FUNCTIONAL_ERROR_RED_LIGHT = themeGet.themeGet('colors.red.200');
var LUP_FUNCTIONAL_ERROR_RED_LIGHTER = themeGet.themeGet('colors.red.100');
var LUP_FUNCTIONAL_ERROR_RED_LIGHTEST = themeGet.themeGet('colors.red.50');
var LUP_SECONDARY_YELLOW = themeGet.themeGet('colors.secondary.yellow');
var LUP_SECONDARY_DEEP_YELLOW = themeGet.themeGet('colors.secondary.deepYellow');
var LUP_SECONDARY_PURPLE = themeGet.themeGet('colors.secondary.purple');
var LUP_SECONDARY_DEEP_PURPLE = themeGet.themeGet('colors.secondary.deepPurple');
var LUP_SECONDARY_CYAN = themeGet.themeGet('colors.secondary.cyan');
var LUP_SECONDARY_DEEP_CYAN = themeGet.themeGet('colors.secondary.deepCyan');
var LUP_SECONDARY_BROWN = themeGet.themeGet('colors.secondary.brown');
var LUP_SECONDARY_DEEP_BROWN = themeGet.themeGet('colors.secondary.deepBrown');
var LUP_SECONDARY_CHARCOAL_BLACK = themeGet.themeGet('colors.secondary.charcoalBlack');
var LUP_STATUS_ACTIVE_UNCONFIRMED = themeGet.themeGet('colors.status.gold');
var LUP_STATUS_IN_PROGRESS = themeGet.themeGet('colors.status.blue');
var LUP_STATUS_UNDER_REVIEW = themeGet.themeGet('colors.status.orange');
var LUP_STATUS_COMPLETE_CONFIRMED = themeGet.themeGet('colors.status.green');
var LUP_STATUS_RETURNED_NON_COMPLIANT_DEADLINE = themeGet.themeGet('colors.status.red');
var LUP_STATUS_CANCELLED_INACTIVE = themeGet.themeGet('colors.status.gray');
var LUP_FORM_ENABLED_BACKGROUND = themeGet.themeGet('colors.form.background.enabled');
var LUP_FORM_DISABLED_BACKGROUND = themeGet.themeGet('colors.form.background.disabled');
var LUP_MAIN_FONT = themeGet.themeGet('font.mainSet');
var LUP_MAIN_FONT_LIGHTEST = themeGet.themeGet('font.weight.lightest');
var LUP_MAIN_FONT_LIGHTER = themeGet.themeGet('font.weight.lighter');
var LUP_MAIN_FONT_LIGHT = themeGet.themeGet('font.weight.light');
var LUP_MAIN_FONT_NORMAL = themeGet.themeGet('font.weight.normal');
var LUP_MAIN_FONT_BOLDER = themeGet.themeGet('font.weight.bolder');
var LUP_MAIN_FONT_BOLD600 = themeGet.themeGet('font.weight.bold600');
var LUP_MAIN_FONT_BOLD700 = themeGet.themeGet('font.weight.bold700');
var LUP_MAIN_FONT_BOLD800 = themeGet.themeGet('font.weight.bold800');
var LUP_MAIN_FONT_BOLDEST = themeGet.themeGet('font.weight.boldest');
var LUP_MAIN_FONT_SIZE4 = themeGet.themeGet('font.size.4');
var LUP_MAIN_FONT_SIZE8 = themeGet.themeGet('font.size.8');
var LUP_MAIN_FONT_SIZE10 = themeGet.themeGet('font.size.10');
var LUP_MAIN_FONT_SIZE12 = themeGet.themeGet('font.size.12');
var LUP_MAIN_FONT_SIZE14 = themeGet.themeGet('font.size.14');
var LUP_MAIN_FONT_SIZE16 = themeGet.themeGet('font.size.16');
var ACCENT_DARK = themeGet.themeGet('colors.accent.dark');
var COMMENT_TEXT_HIGHLIGHT_DARK = themeGet.themeGet('colors.text.highlight.dark');
var COMMENT_TEXT_HIGHLIGHT_LIGHT = themeGet.themeGet('colors.text.highlight.light');
var LUP_MAIN_BORDER_RADIUS24 = themeGet.themeGet('border.radius.24');
var LUP_MAIN_BORDER_RADIUS2 = themeGet.themeGet('border.radius.2');
var LUP_MAIN_BORDER_RADIUS4 = themeGet.themeGet('border.radius.4');
var LUP_MAIN_BORDER_RADIUS6 = themeGet.themeGet('border.radius.6');
var LUP_MAIN_BORDER_WIDTH6 = themeGet.themeGet('border.width.6');
var LUP_MAIN_BORDER_WIDTH2 = themeGet.themeGet('border.width.2');
var LUP_MAIN_BORDER_WIDTH1 = themeGet.themeGet('border.width.1');
var LUP_SPACING_1 = themeGet.themeGet('spacing.size.1');
var LUP_SPACING_2 = themeGet.themeGet('spacing.size.2');
var LUP_SPACING_3 = themeGet.themeGet('spacing.size.3');
var LUP_SPACING_4 = themeGet.themeGet('spacing.size.4');
var LUP_SPACING_5 = themeGet.themeGet('spacing.size.5');
var LUP_SPACING_6 = themeGet.themeGet('spacing.size.6');
var LUP_SPACING_7 = themeGet.themeGet('spacing.size.7');
var LUP_SPACING_8 = themeGet.themeGet('spacing.size.8');
var LUP_SPACING_9 = themeGet.themeGet('spacing.size.9');
var LUP_SPACING_10 = themeGet.themeGet('spacing.size.10');
var LUP_SPACING_11 = themeGet.themeGet('spacing.size.11');
var LUP_SPACING_12 = themeGet.themeGet('spacing.size.12');
var LUP_SPACING_13 = themeGet.themeGet('spacing.size.13');
var LUP_SPACING_14 = themeGet.themeGet('spacing.size.14');
var LUP_SPACING_15 = themeGet.themeGet('spacing.size.15');
var LUP_SPACING_16 = themeGet.themeGet('spacing.size.16');
var LUP_SPACING_17 = themeGet.themeGet('spacing.size.17');
var LUP_SPACING_18 = themeGet.themeGet('spacing.size.18');
var LUP_SPACING_19 = themeGet.themeGet('spacing.size.19');
var LUP_SPACING_20 = themeGet.themeGet('spacing.size.20');
var LUP_SPACING_21 = themeGet.themeGet('spacing.size.21');
var LUP_SPACING_22 = themeGet.themeGet('spacing.size.22');
var LUP_SPACING_23 = themeGet.themeGet('spacing.size.23');
var LUP_SPACING_24 = themeGet.themeGet('spacing.size.24');
var LUP_SPACING_25 = themeGet.themeGet('spacing.size.25');
var LUP_SPACING_26 = themeGet.themeGet('spacing.size.26');
var LUP_SPACING_28 = themeGet.themeGet('spacing.size.28');
var LUP_SPACING_30 = themeGet.themeGet('spacing.size.30');
var LUP_SPACING_32 = themeGet.themeGet('spacing.size.32');
var LUP_SPACING_33 = themeGet.themeGet('spacing.size.33');
var LUP_SPACING_34 = themeGet.themeGet('spacing.size.34');
var LUP_SPACING_35 = themeGet.themeGet('spacing.size.35');
var LUP_SPACING_37 = themeGet.themeGet('spacing.size.37');
var LUP_SPACING_40 = themeGet.themeGet('spacing.size.40');
var LUP_SPACING_42 = themeGet.themeGet('spacing.size.42');
var LUP_SPACING_44 = themeGet.themeGet('spacing.size.44');
var LUP_SPACING_45 = themeGet.themeGet('spacing.size.45');
var LUP_SPACING_50 = themeGet.themeGet('spacing.size.50');
var LUP_SPACING_60 = themeGet.themeGet('spacing.size.60');
var LUP_SPACING_65 = themeGet.themeGet('spacing.size.65');
var LUP_SPACING_66 = themeGet.themeGet('spacing.size.66');
var LUP_SPACING_70 = themeGet.themeGet('spacing.size.70');
var LUP_SPACING_86 = themeGet.themeGet('spacing.size.86');
var LUP_SPACING_100 = themeGet.themeGet('spacing.size.100');
var LUP_SPACING_110 = themeGet.themeGet('spacing.size.110');
var LUP_SPACING_130 = themeGet.themeGet('spacing.size.130');
var LUP_SPACING_134 = themeGet.themeGet('spacing.size.134');
var LUP_SPACING_144 = themeGet.themeGet('spacing.size.144');
var LUP_SPACING_150 = themeGet.themeGet('spacing.size.150');
var LUP_SPACING_160 = themeGet.themeGet('spacing.size.160');
var LUP_SPACING_170 = themeGet.themeGet('spacing.size.170');
var LUP_SPACING_187 = themeGet.themeGet('spacing.size.187');
var LUP_SPACING_196 = themeGet.themeGet('spacing.size.196');
var LUP_SPACING_200 = themeGet.themeGet('spacing.size.200');
var LUP_SPACING_216 = themeGet.themeGet('spacing.size.216');
var LUP_SPACING_230 = themeGet.themeGet('spacing.size.230');
var LUP_SPACING_340 = themeGet.themeGet('spacing.size.340');
var LUP_SPACING_377 = themeGet.themeGet('spacing.size.377');
var LUP_SPACING_443 = themeGet.themeGet('spacing.size.443');
var LUP_SPACING_300 = themeGet.themeGet('spacing.size.300');
var LUP_SPACING_500 = themeGet.themeGet('spacing.size.500');
var LUP_BOX_SHADOW_1 = themeGet.themeGet('box.shadow.1');
var LUP_BOX_SHADOW_2 = themeGet.themeGet('box.shadow.2');
var LUP_BOX_SHADOW_3 = themeGet.themeGet('box.shadow.3');
var LUP_BOX_SHADOW_4 = themeGet.themeGet('box.shadow.4');
var LUP_BOX_SHADOW_5 = themeGet.themeGet('box.shadow.5');
var LUP_BOX_SHADOW_6 = themeGet.themeGet('box.shadow.6');
var LUP_BOX_SHADOW_7 = themeGet.themeGet('box.shadow.7');
var LUP_MODAL_BUTTON_WIDTH_100 = themeGet.themeGet('modal.buttonWidth.100');
var LUP_MODAL_MARGIN_TOP_5 = themeGet.themeGet('modal.marginTop.5');
var LUP_OPACITY_1 = themeGet.themeGet('opacity.value.1');
var colors = {
  white: '#FFFFFF',
  black: '#000000',
  hex: '#000',
...
var StyledChatAvatar = styled__default['default'](_Avatar__default['default'])(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  &.ant-avatar {\n    font-size: 14px;\n    background: ", ";\n    font-weight: ", ";\n    color: ", ";\n    line-height: ", ";\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: ", ";\n    width: ", ";\n  }\n"])), function (props) {
  return props.bg;
}, LUP_MAIN_FONT_BOLD600, WHITE, LUP_SPACING_16, LUP_SPACING_28, LUP_SPACING_28);
var StyledChatBadge = styled__default['default'](_Badge__default['default'])(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n &.ant-badge-count, .ant-badge-dot, .ant-badge .ant-scroll-number-custom-component {\n   height: 10px;\n   width: 10px;\n   background:", ";\n\n }\n"])), LUP_FUNCTIONAL_ERROR_RED);
...
var ChatAvatar = function ChatAvatar(_ref) {
  ...
  var avatar = /*#__PURE__*/React__default['default'].createElement(StyledChatAvatar, {
    bg: avatarColor[type]
  }, children);

  if (showDot) {
    return /*#__PURE__*/React__default['default'].createElement(StyledChatBadge, {
      offset: [-4, 4],
      dot: true
    }, avatar);
  }
...
var StyledBadge = styled__default['default'].span(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  padding: 0 ", ";\n  background: ", ";\n  border-radius: ", ";\n  border: none;\n  font-size: ", ";\n  font-weight: ", ";\n  box-sizing: border-box;\n  color: ", ";\n  min-width: ", ";\n  height: ", ";\n  display: inline-block;\n  text-align: center;\n  line-height: ", ";\n"])), LUP_SPACING_3, function (_ref) {
  var bg = _ref.bg;
  return bg;
...
var CountWrapper = styled__default['default'].div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  min-width: ", ";\n"])), LUP_SPACING_14);

var Badge = function Badge(_ref) {
  var children = _ref.children,
      props = _objectWithoutProperties(_ref, ["children"]);

  return /*#__PURE__*/React__default['default'].createElement(StyledBadge, props, /*#__PURE__*/React__default['default'].createElement(CountWrapper, null, children));
};
...
var StyledBlock = styled__default['default'].div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n"])));

var _templateObject$3, _templateObject2$2, _templateObject3, _templateObject4, _templateObject5, _templateObject6, _templateObject7, _templateObject8;
var StyledPlainButton = styled__default['default'].button(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  appearance: none;\n  background-color: transparent;\n  font-size: ", ";\n  line-height: ", ";\n  font-weight: ", ";\n  box-shadow: none;\n  text-decoration: none;\n  border: none;\n  outline: none;\n  padding: 0;\n  margin: 0;\n  transition: background-color 250ms ease-out, color 250ms ease-out, border-color 250ms ease-out;\n  cursor: pointer;\n\n  &[disabled] {\n    opacity: 1;\n    cursor: not-allowed;\n    font-weight: ", ";\n  }\n"])), LUP_SPACING_12, LUP_SPACING_12, LUP_MAIN_FONT_BOLD700, LUP_MAIN_FONT_NORMAL);
var StylesSecondaryButton = styled$4.css(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n  color: ", ";\n  border-color: ", ";\n  background-color: ", ";\n\n  &:hover,\n  &:focus {\n    color: ", ";\n    border-color: ", ";\n  }\n\n  &:active {\n    color: ", ";\n    border-color: ", ";\n  }\n\n  &[disabled] {\n    color: ", ";\n    border-color: ", ";\n    cursor: not-allowed;\n    background: ", ";\n  }\n"])), LUP_BASE_BLUE, LUP_BASE_BLUE, WHITE, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARKER, LUP_BASE_BLUE_DARKER, LUP_BASE_GREY, LUP_BASE_GREY, LUP_BASE_GREY_LIGHTER);
var StylesPrimaryButton = styled$4.css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  color: ", ";\n  border: none;\n  background-color: ", ";\n\n  &:hover,\n  &:focus {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &[disabled] {\n    color: ", ";\n    border-color: ", ";\n    background-color: ", ";\n    cursor: not-allowed;\n  }\n"])), WHITE, LUP_BASE_BLUE, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARKER, LUP_BASE_BLUE_DARKER, LUP_BASE_GREY_LIGHTEST, LUP_BASE_GREY_LIGHTEST, LUP_BASE_GREY);
var StylesDefaultButton = styled$4.css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  color: ", ";\n  border-color: ", ";\n  background-color: ", ";\n\n  &:hover,\n  &:focus {\n    color: ", ";\n  }\n\n  &:active {\n    color: ", ";\n    border-color: ", ";\n  }\n\n  &[disabled] {\n    color: ", ";\n    border-color: ", ";\n    background-color: ", ";\n    cursor: not-allowed;\n  }\n"])), LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_LIGHT, LUP_BASE_GREY_LIGHTEST, ACCENT_DARK, LUP_BASE_BLUE_DARKER, LUP_BASE_GREY, LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_LIGHT, LUP_BASE_GREY_LIGHTEST);
var StylesCardButton = styled$4.css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  color: ", ";\n  background-color: ", ";\n  box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.1);\n  border-radius: 4px;\n  border-color: ", ";\n"])), LUP_BASE_BLUE, WHITE, LUP_BASE_GREY_LIGHTEST);
var styles = {
...
var StyledButton = styled__default['default'](StyledPlainButton)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  font-weight: ", ";\n  text-transform: ", ";\n  border: 1px solid;\n  padding: 0 10px;\n  border-radius: 4px;\n  display: inline-flex;\n  justify-content: center;\n  flex-flow: row nowrap;\n  white-space: nowrap;\n  align-items: center;\n  font-size: ", ";\n  height: ", "px;\n  min-width: ", "px;\n  ", ";\n"])), LUP_MAIN_FONT_BOLD700, function (_ref) {
...
var rotate360 = styled$4.keyframes(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n\n  to {\n    transform: rotate(360deg);\n  }\n"])));
var StyledSpinner = styled__default['default'].div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  width: 22px;\n  height: 22px;\n  border-radius: 100%;\n  border: 2px solid currentColor;\n  border-bottom-color: transparent;\n  animation: ", " 1.4s infinite linear;\n"])), rotate360);
...
var Button = function Button(_ref) {
  ...
  }), isLoading ? /*#__PURE__*/React__default['default'].createElement(StyledSpinner, null) : children);
};
...
var StyledFlexBlock = styled__default['default'].div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n  border-bottom: 1px solid ", ";\n  padding: ", ";\n  background: ", ";\n  margin: ", ";\n"])), function (_ref) {
...
var StyledLabel = styled__default['default'].label(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  min-width: 160px;\n  display: flex;\n  -webkit-box-pack: start;\n  justify-content: flex-start;\n  -webkit-box-align: center;\n  align-items: center;\n\n  font-weight: ", ";\n  font-size: ", ";\n  line-height: ", ";\n  color: ", ";        \n  color: ", "; \n"])), LUP_MAIN_FONT_BOLD600, LUP_MAIN_FONT_SIZE12, LUP_SPACING_14, function (props) {
...
var SearchInput = function SearchInput(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(StyledSearchInput, {
    value: _value,
  ...
  }), noChatFound && /*#__PURE__*/React__default['default'].createElement(StyledText, {
...
SearchInput.defaultProps = {
  ...
  suffix: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null),
  noChatFound: false,
  placeholder: "Search Keywords"
};

var _templateObject$8;
var StyledText = styled__default['default'].span(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n  font-family: ", ";\n  text-transform: ", ";\n  color: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  line-height: ", ";\n  ", ";\n  ", ";\n  ", ";\n\n  color: ", ";        \n\n"])), LUP_MAIN_FONT, function (_ref) {
  var caps = _ref.caps;
  ...
  return lineHeight;
}, styledSystem.display, styledSystem.textAlign, styledSystem.space, function (props) {
  return props.disabled && LUP_BASE_GREY;
});

var _templateObject$9;
var StyledHighlighter = styled__default['default'].div(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n    height: 10px;\n    background: ", ";\n    border-radius: 4px 4px 0px 0px;\n"])), function (props) {
  return props.color || LUP_BASE_BLUE_DARK;
});

var _templateObject$a;
var StyledImage = styled__default['default'].img(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n  max-width: 100%;\n  height: auto;\n  cursor: pointer;\n  \n  &[disabled] {\n    opacity: 0.5;\n    cursor: not-allowed;\n  }\n"])));
...
var renderOptionList = function renderOptionList(options, optionStyle) {
  return options.map(function (_ref) {
    var key = _ref.key,
        value = _ref.value,
        img = _ref.img;
    return /*#__PURE__*/React__default['default'].createElement(AntOption, {
      key: key || value,
      value: key !== undefined ? key : value,
      style: optionStyle
    }, img ? /*#__PURE__*/React__default['default'].createElement(StyledOptionContent, null, img, /*#__PURE__*/React__default['default'].createElement("span", null, value)) : value);
  });
};
...
var Select = function Select(_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(SelectWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledSelect, _extends({}, props, {
    ...
    labelInValue: true,
    suffixIcon: /*#__PURE__*/React__default['default'].createElement(IconButton, {
      size: "10px",
      style: {
        height: '10px'
      },
    ...
    dropdownRender: function dropdownRender(menu) {
      return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(StyledDropDropArrow, null), menu);
    }
...
var StyledHighlighter$1 = styled__default['default'].span(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral(["\n    background-color: ", ";\n"])), function (_ref) {
...
var StyledMessage = function StyledMessage(_ref) {
  ...
  var highlight = function highlight() {
    ...
    var handlePart = function handlePart(part) {
      ...
      switch (partType) {
        ...
        case HighlightTypes.SEARCH_TEXT:
          return /*#__PURE__*/React__default['default'].createElement(StyledHighlighter$1, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, parts.map(handlePart));
  };
...
var StyledImage$1 = styled__default['default'].img(_templateObject$f || (_templateObject$f = _taggedTemplateLiteral(["\n  width: ", ";\n  height:  ", ";\n  position: relative;\n  margin: auto;\n  display: block;\n  max-width: 100%;\n  max-height: 100%;\n"])), function (props) {
  return props.width;
}, function (props) {
  return props.height;
});
var MissingImagePlaceholder = styled__default['default'].img(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["\n  margin: auto;\n  position: relative;\n  height: ", ";\n  width: auto;\n  max-width: 100%;\n  display: block;\n  max-height: 100%;\n"])), function (props) {
  return props.size;
});
...
var Image = function Image(_ref) {
  ...
  if (!src || hasError) {
    return /*#__PURE__*/React__default['default'].createElement(MissingImagePlaceholder, {
      size: height,
...
var Checkbox = function Checkbox(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledCheckbox, _extends({}, props, {
    onChange: onChange
  }), label && /*#__PURE__*/React__default['default'].createElement(StyledLabel$1, null, label), subLabel && /*#__PURE__*/React__default['default'].createElement(StyledSubLabel, null, subLabel));
};
...
var PropsDecoratorContext = React.createContext(defaultPropsDecorator);
...
var useStyles = function useStyles(defaultStyle, _ref, modifiers) {
  var style = _ref.style,
      className = _ref.className,
      classNames = _ref.classNames;
  var propsDecorator = React.useContext(PropsDecoratorContext);
  var substyle = React.useMemo(function () {
...
function createDefaultStyle(defaultStyle, getModifiers) {
  var enhance = function enhance(ComponentToWrap) {
    var DefaultStyleEnhancer = function DefaultStyleEnhancer(_ref) {
      ...
      return React__default['default'].createElement(ComponentToWrap, _extends$1({}, rest, {
        style: styles
      }));
    };
...
function (_Component) {
  ...
  _createClass$1(Highlighter, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement("div", _extends$1({}, style, {
        ref: containerRef
      }), resultComponents);
    }
  }, {
    ...
    value: function renderSubstring(string, key) {
      ...
      return React__default['default'].createElement("span", _extends$1({}, this.props.style('substring'), {
        key: key
      }), string);
    ...
    value: function renderHighlighterCaret(children) {
      return React__default['default'].createElement("span", _extends$1({}, this.props.style('caret'), {
...
function (_Component) {
  ...
  _createClass$1(Suggestion, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement("li", _extends$1({}, rest, this.props.style), this.renderContent());
    }
  }, {
    key: "renderContent",
    ...
    value: function renderHighlightedDisplay(display) {
      ...
      if (i === -1) {
        return React__default['default'].createElement("span", style('display'), display);
      }

      return React__default['default'].createElement("span", style('display'), display.substring(0, i), React__default['default'].createElement("b", style('highlight'), display.substring(i, i + query.length)), display.substring(i + query.length));
    }
  }]);
...
function (_Component) {
  ...
  _createClass$1(SuggestionsOverlay, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement("div", _extends$1({}, inline({
        ...
        ref: containerRef
      }), React__default['default'].createElement("ul", _extends$1({
    ...
    value: function renderLoadingIndicator() {
      ...
      return React__default['default'].createElement(LoadingIndicator, {
...
function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "renderInput", function (props) {
      return React__default['default'].createElement("input", _extends$1({
        type: "text",
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "renderTextarea", function (props) {
      return React__default['default'].createElement("textarea", _extends$1({
        ref: _this.setInputRef
      }, props));
    });
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "renderSuggestionsOverlay", function () {
      ...
      var suggestionsNode = React__default['default'].createElement(SuggestionsOverlay$1, {
      ...
      if (_this.props.suggestionsPortalHost) {
        return ReactDOM__default['default'].createPortal(suggestionsNode, _this.props.suggestionsPortalHost);
      } else {
...
var StyledChatAvatar$1 = styled__default['default'](_Avatar__default['default'])(_templateObject$i || (_templateObject$i = _taggedTemplateLiteral(["\n  &.ant-avatar {\n    font-size: 14px;\n    background: ", ";\n    font-weight: ", ";\n    color: ", ";\n  }\n"])), function (props) {
  return props.bg;
}, LUP_MAIN_FONT_BOLD600, WHITE);
var StyledChatBadge$1 = styled__default['default'](_Badge__default['default'])(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral(["\n &.ant-badge-count, .ant-badge-dot, .ant-badge .ant-scroll-number-custom-component {\n   height: 10px;\n   width: 10px;\n }\n"])));
...
var ChatAvatar$1 = function ChatAvatar(_ref) {
  var children = _ref.children,
      type = _ref.type,
      showDot = _ref.showDot;
  var avatar = /*#__PURE__*/React__default['default'].createElement(StyledChatAvatar$1, {
    bg: avatarColor$1[type]
  }, children);

  if (showDot) {
    return /*#__PURE__*/React__default['default'].createElement(StyledChatBadge$1, {
      offset: [-4, 4],
      color: LUP_FUNCTIONAL_ERROR_RED,
      dot: true
    }, "ChatAvatar", avatar);
...
var StyledMentionBottomArrow = styled__default['default'].div(_templateObject$j || (_templateObject$j = _taggedTemplateLiteral(["\nleft: 50%;\nbottom: -4.8px;\ntransform: translateX(-50%) rotate(45deg);\nborder-color: ", " transparent transparent ", ";\nbox-shadow: 3px 3px 7px rgba(0,0,0,.07);\nposition: absolute;\nz-index: 1;\ndisplay: block;\nposition: absolute;\nwidth: 12px;\nheight: 10px;\nbackground: ", ";\nborder-style: solid;\nborder-width: 4.24264069px;\n"])), WHITE, WHITE, WHITE);
...
var ChatReactMentions = function ChatReactMentions(_ref) {
  var value = _ref.value,
      ...
      placeholder = _ref.placeholder,
      users = _ref.users;
  return /*#__PURE__*/React__default['default'].createElement(MentionsInput$1, {
    value: value,
    onChange: onChange,
  ...
  }, /*#__PURE__*/React__default['default'].createElement(Mention, {
    type: "user",
    trigger: "@",
    ...
    renderSuggestion: function renderSuggestion(entry, search, highlightedDisplay, index, focused) {
      return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, index === users.length - 1 ? /*#__PURE__*/React__default['default'].createElement(StyledMentionBottomArrow, null) : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null), /*#__PURE__*/React__default['default'].createElement(ChatAvatar$1, null, entry.display.split(' ').map(function (i) {
        return i.charAt(0);
...
var CustomDropDown = function CustomDropDown(_ref) {
  ...
  return visible ? /*#__PURE__*/React__default['default'].createElement(_Dropdown__default['default'], props, children) : /*#__PURE__*/React__default['default'].createElement(_Dropdown__default['default'], _extends({
    visible: false
  }, props), children);
};
...
var StyledImage$2 = styled__default['default'].img(_templateObject$k || (_templateObject$k = _taggedTemplateLiteral(["\n  width: ", ";\n  height:  ", ";\n  position: relative;\n  margin: auto;\n  display: block;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
...
var Cross1 = function Cross1(_ref) {
  var size = _ref.size,
      onClick = _ref.onClick;
  return /*#__PURE__*/React__default['default'].createElement(StyledImage$2, {
    src: Cross,
    size: size,
    onClick: onClick
  });
...
var StyledImage$3 = styled__default['default'].img(_templateObject$l || (_templateObject$l = _taggedTemplateLiteral(["\n  width: ", ";\n  height:  ", ";\n  position: relative;\n  margin: auto;\n  display: block;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
...
var Cross2 = function Cross2(_ref) {
  var size = _ref.size,
      onClick = _ref.onClick;
  return /*#__PURE__*/React__default['default'].createElement(StyledImage$3, {
    src: Cross$1,
    size: size,
    onClick: onClick
  });
...
var StyledImage$4 = styled__default['default'].img(_templateObject$m || (_templateObject$m = _taggedTemplateLiteral(["\n  width: ", ";\n  height:  ", ";\n  position: relative;\n  margin: auto;\n  display: block;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
...
var Cross3 = function Cross3(_ref) {
  var size = _ref.size,
      onClick = _ref.onClick;
  return /*#__PURE__*/React__default['default'].createElement(StyledImage$4, {
    src: Cross$2,
    size: size,
    onClick: onClick
  });
...
var FormSpace = styled__default['default'](StyledBlock)(_templateObject$n || (_templateObject$n = _taggedTemplateLiteral(["\n    height: ", ";\n"])), LUP_SPACING_20);

var _templateObject$o, _templateObject2$7, _templateObject3$3;
var StyledChatListDivider = styled__default['default'].div(_templateObject$o || (_templateObject$o = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  background: ", ";\n  border-radius: 3px;\n\n  width: max-content;\n  margin: 0 auto;\n  margin-top: ", ";\n"])), LUP_SECONDARY_DEEP_CYAN, function (_ref) {
  var marginTop = _ref.marginTop;
  return marginTop;
});
var StyledTextDiv = styled__default['default'].div(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n  justify-content: center;\n  height: 16px;\n  display: flex;\n  padding-right: 6px;\n  padding-left: 6px;\n"])));
var StyledWrapper = styled__default['default'].div(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n  position: sticky; \n  z-index: 1; \n  top: 0;\n  margin: auto;\n"])));
...
var ChatListDateLabel = function ChatListDateLabel(_ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(StyledChatListDivider, {
    marginTop: marginTop
  }, /*#__PURE__*/React__default['default'].createElement(StyledTextDiv, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
...
var StyledComment = styled__default['default'](_Comment__default['default'])(_templateObject$p || (_templateObject$p = _taggedTemplateLiteral(["\n    &.ant-comment {\n        width: 100%;\n        background: ", ";\n        white-space: break-spaces;\n    }\n\n    &.ant-comment\n    > .ant-comment-inner\n    > .ant-comment-content\n    > .ant-comment-content-author\n    > .ant-comment-content-author-name\n    > *:hover {\n        color: ", ";\n    }\n\n    &.ant-comment > .ant-comment-inner {\n        padding: 0px;\n    }\n    \n    &.ant-comment > .ant-comment-nested {\n        margin-left: 0px;\n    }\n\n    &.ant-comment > .ant-comment-inner\n    > .ant-comment-avatar {\n        margin-right: ", "\n    }\n\n    &.ant-comment\n    > .ant-comment-inner\n    > .ant-comment-content\n    > .ant-comment-content-author\n    > .ant-comment-content-author-name {\n        width: 100%;\n        padding-right: 0px;\n    }\n\n    &.ant-comment\n    > .ant-comment-inner\n    > .ant-comment-content\n    > .ant-comment-content-author\n    > .ant-comment-content-author-time {\n        right: 0;\n        position: absolute;\n    }\n\n    &.ant-comment \n    > .ant-comment-inner \n    > .ant-comment-content \n    > .ant-comment-actions {\n        margin: 0px;\n    }\n\n    &.ant-comment \n    > .ant-comment-inner \n    > .ant-comment-content \n    > .ant-comment-actions > li > span {\n        padding-right: ", ";\n        color: #0076BF;\n        font-size: ", ";\n        padding-top: ", ";\n    }\n"])), function (_ref) {
  var background = _ref.background;
  return background;
}, LUP_BASE_GREY_DARKEST, LUP_SPACING_8, LUP_SPACING_7, LUP_MAIN_FONT_SIZE14, LUP_SPACING_6);
var StyledChatAction = styled__default['default'].span(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["\n    padding-right: ", ";\n"])), LUP_SPACING_12);
var StyledChatPinAction = styled__default['default'].span(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral(["\n    padding-left: ", ";\n"])), LUP_SPACING_8);
var StyledChatReplyAction = styled__default['default'].span(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n    color: ", " !important;\n    padding-right: ", ";\n    line-height: ", ";\n"])), function (props) {
  return props.color;
}, LUP_SPACING_13, LUP_SPACING_22);
var StyledChatReplyCountAction = styled__default['default'].span(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["\n"])));
var StyleChatItemBlock = styled__default['default'].div(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n  padding: 0px ", ";\n"])), LUP_SPACING_14);
...
var ChatItem = function ChatItem(_ref) {
  ...
  var _React$useState3 = React__default['default'].useState(checkUpdationTimePassed(updatedAt, config ? config.config_value : DEFAULT_UPDATION_TIME)),
  ...
  if (chatType === ChatTypes.COMMENT) {
    actions.push( /*#__PURE__*/React__default['default'].createElement(StyledChatReplyAction, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
    ...
    /*#__PURE__*/
    // Replies Icon
    React__default['default'].createElement(StyledChatReplyAction, {
      onClick: function onClick() {
        return onTapReply(messageId);
      },
    ...
    if (replyItems && replyItems.length > 0) {
      actions.push( /*#__PURE__*/React__default['default'].createElement(StyledChatReplyCountAction, null, /*#__PURE__*/React__default['default'].createElement(Badge, {
        onClick: function onClick() {
          return onTapReply(messageId);
        },
  ...
  var _chatItem = /*#__PURE__*/React__default['default'].createElement(StyledComment, {
    actions: !isReply ? actions : null,
    author: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
      fontSize: LUP_MAIN_FONT_SIZE14,
      lineHeight: LUP_SPACING_22
    }, author), isPinned && /*#__PURE__*/React__default['default'].createElement(StyledChatPinAction, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
      src: PinInternalIcon,
      onClick: function onClick() {
        return onTapPin(messageId);
      }
    }))),
    avatar: /*#__PURE__*/React__default['default'].createElement(ChatAvatar, {
      type: userType // internal/external
      ,
      showDot: isNew // showDot if newNotification

    }, avatar, " "),
    content: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(StyledMessage, {
      text: message // userIndices={userIndices}
      ,
      config: getHighlightData()
    }), children),
    datetime: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, canEdit && !updationTimeWindowPassed && /*#__PURE__*/React__default['default'].createElement(StyledChatAction, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
      src: selectedChatRoomIndex % 2 !== 0 ? EditIconExternal : EditIconInternal,
      onClick: function onClick() {
        return onTapEdit(messageId);
      }
    })), canDelete && !updationTimeWindowPassed && /*#__PURE__*/React__default['default'].createElement(StyledChatAction, null, renderLoader(isDeleteLoading)), /*#__PURE__*/React__default['default'].createElement(StyledText, {
      fontSize: LUP_MAIN_FONT_SIZE12,
      color: LUP_BASE_GREY_DARK,
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledFlexBlock, {
...
var StyledFlexBlock$1 = styled__default['default'](StyledFlexBlock)(_templateObject$q || (_templateObject$q = _taggedTemplateLiteral(["\n    margin: 0px ", " 0px ", ";\n"])), LUP_SPACING_17, LUP_SPACING_15);
var StyledEditComment = styled__default['default'](StyledComment)(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["\n    &.ant-comment \n    > .ant-comment-inner \n    > .ant-comment-content \n    > .ant-comment-actions {\n        padding-top: ", "\n    }\n    &.ant-comment \n    > .ant-comment-inner \n    > .ant-comment-content \n    > .ant-comment-actions\n    > li {\n        padding-right: ", "\n    }\n\n    &.ant-comment \n    > .ant-comment-inner \n    > .ant-comment-content {\n        margin-right: ", "\n    }\n\n    &.ant-comment > .ant-comment-inner\n    > .ant-comment-avatar {\n        margin-right: ", ";\n    }\n"])), LUP_SPACING_10, LUP_SPACING_20, LUP_SPACING_17, LUP_SPACING_15);
...
var ChatEditBox = function ChatEditBox(_ref) {
  ...
  var _React$useState3 = React__default['default'].useState(children),
      _React$useState4 = _slicedToArray(_React$useState3, 2),
  ...
  var renderLoader = function renderLoader(loading) {
    if (loading && key === messageId) {
      return /*#__PURE__*/React__default['default'].createElement("label", null, /*#__PURE__*/React__default['default'].createElement(Spinner, {
        style: {},
        size: "16px"
      }));
    } else {
      return /*#__PURE__*/React__default['default'].createElement("label", null, "Save");
    }
  };

  return /*#__PURE__*/React__default['default'].createElement(StyledFlexBlock$1, {
    borderColor: FlexBlockChatBorderColor[chatType],
    background: FlexBlockChatBackground[chatType],
    padding: FlexBlockChatPadding[chatType]
  }, /*#__PURE__*/React__default['default'].createElement(StyledEditComment, {
    key: messageId,
    author: /*#__PURE__*/React__default['default'].createElement(ChatInputArea, {
      value: message,
    ...
    avatar: chatType === ChatTypes.COMMENT ? /*#__PURE__*/React__default['default'].createElement(ChatAvatar, {
      type: userType // internal/external
      ,
      showDot: isNew // showDot if newNotification

    }, avatar, " ") : null,
    actions: [/*#__PURE__*/React__default['default'].createElement(Button, {
      size: "small",
      colored: "secondary",
      onClick: function onClick() {
...
var StyleChatSubmitBox = styled__default['default'].div(_templateObject$r || (_templateObject$r = _taggedTemplateLiteral(["\n  display: flex;\n  background: ", ";\n  box-shadow: ", ";\n  min-height: ", ";\n\n  justify-content: center;\n  align-items: center;\n"])), LUP_BASE_GREY_LIGHTEST, LUP_BOX_SHADOW_5, LUP_SPACING_65);
var StyleChatSubmitIcon = styled__default['default'].div(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral(["\n  padding: 0 ", ";\n  position: relative;\n  float: right;\n  display: flex;\n"])), LUP_SPACING_10);
var StyledBlock$1 = styled__default['default'](StyledBlock)(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["\n  display: inline-block;\n  width: 100%;\n  padding: ", ";\n  padding-right: 0;\n  padding-bottom: ", ";\n  padding-top: ", ";\n"])), LUP_SPACING_15, function (props) {
  return props.attachmentsLength ? 0 : LUP_SPACING_15;
}, function (props) {
  return props.boxLabel ? 0 : LUP_SPACING_15;
});
var StyledRow = styled__default['default'](_Row__default['default'])(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["\n  display: inline-block;\n  width: 100%;\n"])));
...
var ChatSubmitBox = function ChatSubmitBox(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyleChatSubmitBox, null, /*#__PURE__*/React__default['default'].createElement(StyledBlock$1, {
    attachmentsLength: attachments.length,
    boxLabel: boxLabel
  }, boxLabel && /*#__PURE__*/React__default['default'].createElement(StyledBlock, {
    style: {
  ...
  }, boxLabel)), /*#__PURE__*/React__default['default'].createElement(StyledRow, null, /*#__PURE__*/React__default['default'].createElement(ChatInputArea, {
    value: message,
    users: users,
    onChange: handleChange,
    ...
    canAddAttachments: canAddAttachments,
    placeholder: placeholder
  })), messageLengthError && /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    color: "#E00000",
    fontSize: LUP_MAIN_FONT_SIZE12
  }, messageLengthError)), fileCountError && /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    color: "#E00000",
    fontSize: LUP_MAIN_FONT_SIZE12
  }, fileCountError)), attachments && attachments.length > 0 && /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], {
    style: {
      padding: '2px'
    }
  }, /*#__PURE__*/React__default['default'].createElement(ChatAttachments, {
    attachments: attachments,
    deleteAttachment: deleteAttachment,
    setFileCountError: setFileCountError,
    cancelAttachmentUpload: cancelAttachmentUpload
  }))), /*#__PURE__*/React__default['default'].createElement(StyleChatSubmitIcon, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
    size: LUP_SPACING_30,
...
var StyledSelect$1 = styled__default['default'](Select)(_templateObject$s || (_templateObject$s = _taggedTemplateLiteral(["\n  &.ant-select {\n    border: none;\n    width: ", ";\n    background: ", ";\n  }\n\n  &.ant-select\n    > .ant-select-selection--single\n    > .ant-select-selection__rendered {\n    color: #2d9cdb;\n    font-weight: ", ";\n    width: ", ";\n  }\n\n  .ant-select-selection-selected-value {\n    padding-top: ", ";\n    padding-right: ", " !important;\n  }\n\n  .ant-select-selection {\n    width: ", ";\n    padding-left: 0;\n  }\n\n  .ant-select-selection--single .ant-select-selection__rendered {\n    margin-right: ", ";\n    margin-left: ", ";\n    width: ", ";\n  }\n\n  .ant-select-arrow {\n    position: absolute;\n    right: ", ";\n    padding-top: ", ";\n  }\n"])), LUP_SPACING_50, WHITE, LUP_MAIN_FONT_BOLD600, LUP_SPACING_50, LUP_SPACING_4, LUP_SPACING_5, LUP_SPACING_50, LUP_SPACING_8, LUP_SPACING_4, LUP_SPACING_40, LUP_SPACING_5, LUP_SPACING_2);
var StyledFlexBlock$2 = styled__default['default'](StyledFlexBlock)(_templateObject2$b || (_templateObject2$b = _taggedTemplateLiteral(["\n  color: ", ";\n  font-weight: ", ";\n  font-size: ", ";\n  margin: 0px ", " 0px 0px;\n  padding: 0px;\n"])), LUP_BASE_GREY_DARKEST, LUP_MAIN_FONT_BOLD600, LUP_MAIN_FONT_SIZE14, LUP_SPACING_20);
var StyledBlockWrapper = styled__default['default'].div(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteral(["\n  display: flex;\n  border-bottom: none;\n  align-items: center;\n  justify-content: space-between;\n  line-height: ", ";\n"])), LUP_SPACING_16);
var StyledWrapper$1 = styled__default['default'].div(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n  display: flex;\n  border-bottom: none;\n  align-items: center;\n  justify-content: space-between;\n  height: ", ";\n  padding: ", " ", " ", " ", "\n"])), LUP_SPACING_34, LUP_SPACING_8, LUP_SPACING_15, LUP_SPACING_10, LUP_SPACING_15);
...
var ChatHeader = function ChatHeader(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledWrapper$1, null, /*#__PURE__*/React__default['default'].createElement(StyledBlockWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledFlexBlock$2, null, headerText), showVersions && /*#__PURE__*/React__default['default'].createElement(StyledFlexBlock, {
    style: {
      flexGrow: "1",
      borderBottom: "none",
      justifyContent: "flex-start",
  ...
  }, suffix)), /*#__PURE__*/React__default['default'].createElement(StyledBlockWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledFlexBlock, {
    style: {
      borderBottom: "none",
      padding: "0px",
      margin: "0px"
    }
  }, showCloseIcon ? /*#__PURE__*/React__default['default'].createElement(IconButton, {
    src: CrossIcon,
    onClick: onClose,
    size: LUP_SPACING_12
  }) : null)));
...
var StyledCommentOptionsBlock = styled__default['default'].div(_templateObject$t || (_templateObject$t = _taggedTemplateLiteral(["\n  position: relative;\n  flex-grow: 1;\n  width: 100%;\n  \n\n  .ant-radio-group {\n    width: 100%;\n  }\n\n  .ant-radio-button-wrapper {\n    width: ", ";\n    line-height: 40px;\n    height: 40px;\n    font-size: 14px;\n    font-weight: ", ";\n    text-align: center;\n    vertical-align: middle;\n    padding: 0px 8px;\n\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    display: inline-block;\n\n    color: #888888 !important;\n    :active {\n      color: #888888 !important;\n    }\n  }\n  \n  .ant-radio-button-wrapper:last-child {\n    border-radius: 0;\n  }\n\n  .ant-radio-button-wrapper:first-child{\n    border-radius: 0;\n  }\n\n  .ant-radio-button-wrapper-checked {\n    font-weight: ", ";\n    // text-shadow: 0px 3px 4px rgba(0, 0, 0, 0.2);\n\n    color: #fff !important;\n    :active {\n      color: #fff !important;\n    }\n  }\n\n  .ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled) {\n    box-shadow: none !important;\n  }\n"])), function (props) {
  return props.optionsWidth;
}, LUP_MAIN_FONT_NORMAL, LUP_MAIN_FONT_BOLD600);
var StyledBadge$1 = styled__default['default'](_Badge__default['default'])(_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral(["\n  .ant-badge-count {\n    background: ", ";\n  }\n\n &.ant-badge {\n    right: ", ";\n    position: absolute;\n }\n"])), function (props) {
  return props.bgColor;
}, LUP_SPACING_15);
var StyledDiv = styled__default['default'].div(_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteral(["\n  display: flex; \n  align-items: center; \n  justify-content: center;\n  height: 100%;\n"])));
...
var renderRadioButtons = function renderRadioButtons(buttons, activeButton) {
  return buttons.map(function (button, i) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(_Radio__default['default'].Button, {
      ...
      id: value.id
    }, /*#__PURE__*/React__default['default'].createElement(StyledDiv, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    ...
    }, label), /*#__PURE__*/React__default['default'].createElement(StyledBadge$1, {
      count: count,
...
var ChatHeaderTabs = function ChatHeaderTabs(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledCommentOptionsBlock, {
...
var StyledBlock$2 = styled__default['default'](StyledBlock)(_templateObject$u || (_templateObject$u = _taggedTemplateLiteral(["\n    padding-top: ", ";\n"])), LUP_SPACING_8);
...
var ChatAttachments = function ChatAttachments(_ref) {
  var attachments = _ref.attachments,
      ...
      isFocused = _ref.isFocused;
  return /*#__PURE__*/React__default['default'].createElement(StyledBlock$2, null, attachments && attachments.map(function (attachment) {
    return /*#__PURE__*/React__default['default'].createElement(AttachmentCard, {
      isFocused: isFocused,
...
var StyledAttachmentCard = styled__default['default'].div(_templateObject$v || (_templateObject$v = _taggedTemplateLiteral(["\n    display: inline-block;  \n    margin: ", " ", " 0 0; \n    width: ", "; \n    height: ", "; \n    border: 1px solid;\n    border-color: ", ";\n    border-color: ", ";\n    border-color: ", ";\n    background: ", ";\n    border-radius: ", " ;\n    padding: ", " ", ";\n    margin-top: -", ";\n"])), LUP_SPACING_5, LUP_SPACING_11, LUP_SPACING_170, LUP_SPACING_32, function (props) {
...
var StyledProgressBar = styled__default['default'](_Progress__default['default'])(_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral(["\n    .ant-progress-outer {\n        margin-top: -", ";\n        position: absolute;\n\n        .ant-progress-bg {\n            background-image: linear-gradient(to right, ", ", ", ") !important;\n        }\n    }\n"])), LUP_SPACING_22, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARK);
var StyledText$1 = styled__default['default'](StyledText)(_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteral(["\n    color: ", ";\n    color: ", ";\n    color: ", ";\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    width: ", ";\n    display: block;\n    overflow: hidden;\n    line-height: ", ";\n"])), function (props) {
...
var StyledLink = styled__default['default'].a(_templateObject4$6 || (_templateObject4$6 = _taggedTemplateLiteral(["\n    color: ", ";\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    width: ", ";\n    display: block;\n    overflow: hidden;\n\n    &:hover, &:active, &:focus {\n        color: ", ";\n    }\n"])), function (props) {
  return props.isHighlighted ? LUP_BASE_GREY_DARKER : LUP_BASE_BLUE_DARK;
}, LUP_SPACING_130, LUP_BASE_BLUE_DARK);
var IconButtonWrapper = styled__default['default'](StyledBlock)(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["\n    padding-right: ", ";\n"])), LUP_SPACING_4);
...
var AttachmentCard = function AttachmentCard(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledAttachmentCard, {
    isHighlighted: isHighlighted,
    isHighlightedAndFocused: isHighlightedAndFocused,
    isUploading: isUploading,
    isError: attachment.error
  }, /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], null, /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
    span: 4
  }, /*#__PURE__*/React__default['default'].createElement(IconButton, {
    src: fileIcon,
    size: "20px"
  })), parent === "chatItems" ? /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
    span: 20
  }, /*#__PURE__*/React__default['default'].createElement(StyledLink, {
    href: src,
    isHighlighted: isHighlighted,
    target: "_blank"
  }, attachment.name)) : /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
    span: isUploading && !isError ? 12 : 16
  }, /*#__PURE__*/React__default['default'].createElement(StyledText$1, {
    isHighlighted: isHighlighted,
    isUploading: isUploading
  }, attachment.name)), parent !== "chatItems" && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, isUploading && !isError && /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
    span: 4
  }, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    color: LUP_BASE_BLUE_DARK,
    fontSize: "10px"
  }, attachment.progress, "%")), /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
    span: 4,
    style: {
      display: 'flex',
      justifyContent: 'flex-end'
    }
  }, /*#__PURE__*/React__default['default'].createElement(IconButtonWrapper, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
  ...
  }))))), parent !== "chatItems" && !isError && /*#__PURE__*/React__default['default'].createElement(StyledProgressBar, {
  ...
  }), isError && /*#__PURE__*/React__default['default'].createElement(StyledText, {
    color: LUP_FUNCTIONAL_ERROR_RED,
    fontSize: LUP_MAIN_FONT_SIZE12,
...
var StyledChatAction$1 = styled__default['default'].div(_templateObject$w || (_templateObject$w = _taggedTemplateLiteral(["\n    padding-left:", ";\n    padding-right:", ";\n    display: inline-flex;\n    float: right;\n"])), LUP_SPACING_8, LUP_SPACING_10);
var StyledChatInputTextArea = styled__default['default'].div(_templateObject2$e || (_templateObject2$e = _taggedTemplateLiteral(["\n    border:  ", " solid ", ";\n    background-color: ", " !important;\n    border-radius: ", ";\n    position: relative;\n    display: flex;\n    min-height: ", ";\n    height: fit-content;\n    &:hover,\n    &:focus,\n    &:active,\n    &:focus-within {\n      outline: none;\n      border-width: ", ";\n      border-style: solid;\n      border-color: ", ";\n    }\n  \n    &:focus,\n    &:active,\n    &:focus-within {\n      border-width: ", ";\n    }\n"])), LUP_MAIN_BORDER_WIDTH1, LUP_BASE_GREY, WHITE, LUP_MAIN_BORDER_WIDTH2, LUP_SPACING_33, LUP_MAIN_BORDER_WIDTH2, function (props) {
  return props.index ? LUP_SECONDARY_DEEP_YELLOW : LUP_BASE_BLUE_DARK;
}, LUP_MAIN_BORDER_WIDTH2);
var StyledBlock$3 = styled__default['default'](StyledBlock)(_templateObject3$9 || (_templateObject3$9 = _taggedTemplateLiteral(["\n  padding: ", " ", " ", " 0;\n  min-width: ", ";\n  height: ", ";\n  float: right;\n  background-color: ", " !important;\n"])), LUP_SPACING_8, LUP_SPACING_2, LUP_SPACING_8, LUP_SPACING_70, LUP_SPACING_33, WHITE);
...
var ChatInputArea = function ChatInputArea(_ref) {
  var placeholder = _ref.placeholder,
      ...
      selectedChatRoomIndex = _ref.selectedChatRoomIndex,
      canAddAttachments = _ref.canAddAttachments;
  var attachmentUploaderRef = /*#__PURE__*/React__default['default'].createRef();
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(StyledChatInputTextArea, {
    messageLengthError: messageLengthError,
    index: selectedChatRoomIndex % 2 !== 0
  }, /*#__PURE__*/React__default['default'].createElement(ChatReactMentions, {
    users: users,
    placeholder: placeholder,
    value: value,
    onChange: onChange
  }), /*#__PURE__*/React__default['default'].createElement(StyledBlock$3, null, canAddAttachments && /*#__PURE__*/React__default['default'].createElement(StyledChatAction$1, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
  ...
  })), /*#__PURE__*/React__default['default'].createElement(StyledChatAction$1, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
...
var CommentItems = function CommentItems(_ref) {
  ...
  return commentItems.map(function (commentItem) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, !isDateLabelAlreadyAdded && /*#__PURE__*/React__default['default'].createElement(ChatListDateLabel, {
      marginTop: LUP_SPACING_15
    }, date), commentIsEditing && !commentShowReplies && /*#__PURE__*/React__default['default'].createElement(ChatEditBox, _extends({}, commentItem, {
      chatType: "comment",
      users: users,
      ...
      selectedChatRoomIndex: selectedChatRoomIndex
    }), commentItem.text), commentShowReplies && /*#__PURE__*/React__default['default'].createElement(ReplyItems, {
      ...
      users: users,
      configs: configs
    }), !commentIsEditing && !commentShowReplies && /*#__PURE__*/React__default['default'].createElement(ChatItem, _extends({
...
var ReplyItems = function ReplyItems(_ref) {
  ...
  return replyItems.map(function (replyItem) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, !isDateLabelAlreadyAdded && /*#__PURE__*/React__default['default'].createElement(ChatListDateLabel, {
      marginTop: LUP_SPACING_15
    }, date), commentIsEditing && /*#__PURE__*/React__default['default'].createElement(ChatEditBox, _extends({}, replyItem, {
      chatType: "comment",
      users: users,
      onCancel: onCancelEditMessage,
      onSave: onSaveEditMessage,
      isEditLoading: isEditLoading,
      selectedChatRoomIndex: selectedChatRoomIndex
    }), replyItem.text), !commentIsEditing && /*#__PURE__*/React__default['default'].createElement(ChatItem, _extends({
...
var ChatItems = function ChatItems(_ref) {
  var chatItems = _ref.chatItems,
      ...
      highLightedReplyId = _ref.highLightedReplyId,
      configs = _ref.configs;
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, chatType === ChatTypes.COMMENT ? /*#__PURE__*/React__default['default'].createElement(CommentItems, {
    ...
    highLightedReplyId: highLightedReplyId,
    configs: configs
  }) : /*#__PURE__*/React__default['default'].createElement(ReplyItems, {
...
var StyledLabel$2 = styled__default['default'].span(_templateObject$x || (_templateObject$x = _taggedTemplateLiteral(["\n  font-weight: ", ";\n  font-size: ", ";\n  line-height: ", ";\n  color: ", ";\n"])), LUP_MAIN_FONT_BOLD600, LUP_MAIN_FONT_SIZE16, LUP_SPACING_20, LUP_BASE_BLUE_DARKER);
var StyledComparisonName = styled__default['default'](StyledText)(_templateObject2$f || (_templateObject2$f = _taggedTemplateLiteral(["\n  font-weight: ", ";\n  font-size: ", ";\n  line-height: ", ";\n  padding-left: ", ";\n"])), LUP_MAIN_FONT_BOLD600, LUP_MAIN_FONT_SIZE16, LUP_SPACING_24, LUP_SPACING_20);
var StyledTable = styled__default['default'](_Table__default['default'])(_templateObject3$a || (_templateObject3$a = _taggedTemplateLiteral(["\n  display: flex;\n  white-space: pre-line;\n  margin-bottom: ", ";\n  .ant-table {\n    border: none;\n    height: 100%;\n\n    table {\n      table-layout: fixed;\n    }\n  }\n\n  .ant-table-small > .ant-table-content > .ant-table-body {\n    margin: 0;\n  }\n\n  .ant-table-placeholder {\n    border-top: none;\n    background: ", ";\n  }\n\n  .ant-empty-normal .ant-empty-image, .ant-empty-description {\n    display: none;\n  }\n\n  .ant-table-thead {\n    & > tr:first-child > th:first-child {\n      border-top-left-radius: 0;\n    }\n\n    & > tr:first-child > th {\n      padding: 0 !important;\n    }\n\n    & > tr:first-child > th:last-child {\n      border-top-right-radius: 0;\n    }\n\n    & > tr > th {\n      background: none;\n      #color: ", ";\n      font-size: ", ";\n      font-weight: ", ";\n      padding: ", " ", ";\n    }\n  }\n\n  .ant-table-tbody {\n    & tr:nth-child(2n) {\n      background-color: ", ";\n    }\n    & tr:nth-child(2n + 1) {\n      background-color: ", ";\n    }\n\n    & tr:nth-child(1) > td{\n      vertical-align: middle;\n      padding-left: 0 !important;\n      padding-right: ", " !important;\n    }\n\n    & > tr > td {\n      width: ", " !important;\n      //border: none;\n      font-size: ", ";\n      line-height: ", ";\n      text-align: center;\n      color: ", ";\n      // vertical-align: top;\n    }\n  }\n\n  .ant-table-empty .ant-table-body {\n    overflow-x: inherit !important;\n    overflow-y: unset !important;\n  }\n\n  .ant-table .ant-table-tbody > tr:hover > td {\n    background: unset;\n  }\n\n  .property {\n    width: ", ";\n    white-space: pre-line;\n    font-weight: ", ";\n    font-size: ", ";\n    line-height: ", ";\n    color: ", " !important;\n    text-align: left !important;\n    padding: ", " 0 0 ", " !important;\n  }\n  .min-column-width {\n    width: ", ";\n  }\n  .primary {\n    border-left: ", " solid ", " !important;\n    border-right: ", " solid ", " !important;\n    padding: ", " ", " !important;\n    vertical-align: middle !important;\n  }\n  .secondary {\n    border-left: ", " solid ", " !important;\n    border-right: ", " solid ", " !important;\n    padding: ", " ", " !important;\n    vertical-align: middle !important;\n  }\n  .sectionTitle {\n    padding:  ", " !important;\n    padding-left:  ", " !important;\n    height: ", ";\n    vertical-align: bottom !important;\n  }\n  .divider {\n    width:  ", ";\n    background: ", ";\n    border: none;\n    background: ", ";\n  }\n  .first_divider {\n    width:  ", ";\n    background: ", ";\n    border: none;\n    background: ", ";\n  }\n  .highlight {\n    background: ", ";\n  }\n  .highlightCheckbox {\n    padding-left: 0 !important; \n    border-bottom: 0;\n    padding-top: ", " !important; \n    position: relative;\n    padding-bottom: ", " !important;\n    padding-right: 0px !important;\n  }\n  .viewerSelector {\n    padding: 0 ", " !important;\n  }\n  .viewerSelectorFirstCol {\n    padding: 0 ", " !important;\n  }\n"])), LUP_SPACING_28, LUP_BASE_GREY_LIGHTEST, LUP_BASE_BLUE_DARKER, LUP_MAIN_FONT_SIZE12, LUP_MAIN_FONT_BOLD600, LUP_SPACING_14, LUP_SPACING_8, LUP_BASE_GREY_LIGHTEST, WHITE, LUP_SPACING_2, LUP_SPACING_150, LUP_MAIN_FONT_SIZE12, LUP_SPACING_18, LUP_BASE_GREY_DARKER, LUP_SPACING_187, LUP_MAIN_FONT_BOLD600, LUP_MAIN_FONT_SIZE12, LUP_SPACING_14, LUP_BASE_GREY_DARKEST, LUP_SPACING_5, LUP_SPACING_16, LUP_SPACING_200, LUP_MAIN_BORDER_WIDTH2, LUP_BASE_BLUE, LUP_MAIN_BORDER_WIDTH2, LUP_BASE_BLUE, LUP_SPACING_5, LUP_SPACING_10, LUP_MAIN_BORDER_WIDTH1, LUP_BASE_GREY_LIGHT, LUP_MAIN_BORDER_WIDTH1, LUP_BASE_GREY_LIGHT, LUP_SPACING_5, LUP_SPACING_10, LUP_SPACING_4, LUP_SPACING_16, LUP_SPACING_44, LUP_SPACING_16, WHITE, LUP_BASE_GREY_LIGHTEST, LUP_SPACING_16, WHITE, LUP_BASE_GREY_LIGHTEST, LUP_FUNCTIONAL_ALERT_YELLOW_LIGHTER, LUP_SPACING_15, LUP_SPACING_7, LUP_SPACING_8, LUP_SPACING_2);
var StyledCheckbox$1 = styled__default['default'](Checkbox)(_templateObject4$7 || (_templateObject4$7 = _taggedTemplateLiteral(["\n  float: right;\n  .ant-checkbox + span + span  {\n      color: ", " !important;\n      font-size: ", ";\n      padding-left:  ", ";\n      padding-right: 0;\n  }\n\n  .ant-checkbox { \n      line-height:  ", ";\n  }\n  \n  .ant-checkbox-wrapper {\n    height: ", ";\n  }\n"])), LUP_BASE_GREY_DARK, LUP_MAIN_FONT_SIZE14, LUP_SPACING_4, LUP_SPACING_22, LUP_SPACING_22);
var CheckboxWrapper = styled__default['default'].div(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n  right: 0;\n"])));
var StyledBlock$4 = styled__default['default'](StyledBlock)(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral(["\n  padding: 0;\n"])));
var StyledText$2 = styled__default['default'](StyledText)(_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral(["\n  color: ", ";\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  font-weight: ", ";\n  font-size: ", ";\n  float: right;\n\n  &[disabled] {\n    opacity: 1;\n    cursor: not-allowed;\n    color: ", "\n  }\n"])), LUP_BASE_BLUE_DARK, LUP_MAIN_FONT_NORMAL, LUP_MAIN_FONT_SIZE14, LUP_BASE_GREY);
var GridWrapper = styled__default['default'](StyledBlock)(_templateObject8$1 || (_templateObject8$1 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n"])));
var TitleWrapper = styled__default['default'](StyledBlock)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral([""])));
var TableWrapper = styled__default['default'](StyledBlock)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  position: relative;\n  display: flex;\n  flex-grow: 1;\n  overflow-x: auto;\n"])));
var StyledRow$1 = styled__default['default'](_Row__default['default'])(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  padding-bottom: ", ";\n"])), LUP_SPACING_11);
var StyledBlockBottomPadding = styled__default['default'](StyledBlock)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  padding-bottom: ", "\n"])), function (props) {
  return props.size;
});
var StyledtrTopBottomPadding = styled__default['default'].tr(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  padding: ", " 0;\n"])), function (props) {
  return props.size;
});
var StyledDiv$1 = styled__default['default'].div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  text-align: left;\n"])));
...
var GridHeaderCell = function GridHeaderCell(props) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(StyledBlock, null, /*#__PURE__*/React__default['default'].createElement(_Card__default['default'], {
    style: {
      height: 200
    }
  }, "Titles")));
...
var StyledSecondCol = styled__default['default'].td(_templateObject$y || (_templateObject$y = _taggedTemplateLiteral(["\n  height: 30px;\n  display: flex;\n  flex-grow: 1;\n  vertical-align: middle;\n  align-items: center;\n  border-radius: 0px;\n  background:", ";\n  box-shadow: 0px 1px 8px rgba(136, 136, 136, 0.35);\n  justify-content: space-between;\n  padding-top: 0px !important;\n  padding-bottom: 0px !important;\n  margin-top: ", " !important;\n"])), WHITE, LUP_SPACING_9);
var StyledDiv$2 = styled__default['default'].div(_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral(["\n  flex-grow: 1;\n  display: flex;\n  justify-content: flex-end;\n  margin-right:  ", ";\n  text-align: left;\n  padding: ", " 0px ", " ", ";\n"])), LUP_SPACING_24, LUP_SPACING_5, LUP_SPACING_5, LUP_SPACING_11);
var StyledFirstDiv = styled__default['default'].td(_templateObject3$b || (_templateObject3$b = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-left: ", ";\n"])), function (props) {
  return props.marginLeft;
});
var StyledButton$1 = styled__default['default'](Button)(_templateObject4$8 || (_templateObject4$8 = _taggedTemplateLiteral(["\n  border-radius: 0 ", " ", " 0;\n  min-width: ", ";\n  width: ", ";\n  height: ", ";\n  margin-left: ", ";\n"])), LUP_SPACING_4, LUP_SPACING_4, LUP_SPACING_30, LUP_SPACING_30, LUP_SPACING_30, LUP_SPACING_3);
var StyledRow$2 = styled__default['default'].tr(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["\n  vertical-align: middle;\n"])));
var StyledSecondRow = styled__default['default'].tr(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])));
var StyledCol = styled__default['default'].td(_templateObject7$2 || (_templateObject7$2 = _taggedTemplateLiteral(["\n  border: none !important;\n  text-align: right;\n  padding-top: 0px !important;\n  padding-bottom: 0px !important;\n  margin-top: ", " !important;\n  background: ", ";\n"])), LUP_SPACING_9, LUP_BASE_GREY_LIGHTEST);
var SelectAllWrapper = styled__default['default'].div(_templateObject8$2 || (_templateObject8$2 = _taggedTemplateLiteral(["\n  padding-top: 0px !important;\n  padding-bottom: 0px !important;\n  margin-top: ", " !important;\n"])), LUP_SPACING_9);
...
var ComparisonViewSelector = function ComparisonViewSelector(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledRow$2, {
    className: "viewerSelector"
  }, /*#__PURE__*/React__default['default'].createElement(StyledCol, {
    className: "viewerSelectorFirstCol"
  }, /*#__PURE__*/React__default['default'].createElement(SelectAllWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledDiv$2, null, /*#__PURE__*/React__default['default'].createElement(Checkbox, {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(StyledSecondRow, null, /*#__PURE__*/React__default['default'].createElement(StyledSecondCol, null, itemsToCompare.map(function (product) {
    return /*#__PURE__*/React__default['default'].createElement(StyledFirstDiv, {
      id: product,
  ...
  })), /*#__PURE__*/React__default['default'].createElement(StyledCol, null, /*#__PURE__*/React__default['default'].createElement(StyledButton$1, {
...
var StyledCard = styled__default['default'](_Card__default['default'])(_templateObject$z || (_templateObject$z = _taggedTemplateLiteral(["\n  border-width: ", ";\n  border-style: solid;\n  border-color: ", ";  \n\n  .ant-card-body {\n    padding: ", " ", ";\n    padding-top: ", ";\n    padding-bottom: ", ";\n    min-height: 140px;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n  }\n  box-shadow: ", ";\n"])), function (props) {
  return props.borderWidth;
}, function (props) {
  return props.color;
}, LUP_SPACING_4, LUP_SPACING_2, LUP_SPACING_5, LUP_SPACING_7, LUP_BOX_SHADOW_3);
var TitleText = styled__default['default'](StyledText)(_templateObject2$h || (_templateObject2$h = _taggedTemplateLiteral(["\n  padding-left: ", ";\n  padding-top: ", ";\n  padding-bottom: ", ";\n  overflow: hidden;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n"])), LUP_SPACING_8, LUP_SPACING_2, LUP_SPACING_2);
var StyledText$3 = styled__default['default'](StyledText)(_templateObject3$c || (_templateObject3$c = _taggedTemplateLiteral(["\n  padding-left: ", ";\n  padding-top: ", ";\n  padding-bottom: ", ";\n  overflow: hidden;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  height: ", ";\n"])), LUP_SPACING_8, LUP_SPACING_2, LUP_SPACING_2, LUP_SPACING_37);
var StyledBlock$5 = styled__default['default'](StyledBlock)(_templateObject4$9 || (_templateObject4$9 = _taggedTemplateLiteral(["\n  position: absolute;\n  padding: ", " ", " 0;\n"])), LUP_MAIN_FONT_SIZE4, LUP_MAIN_FONT_SIZE10);
var ExpandButtonWrapper = styled__default['default'].div(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral(["\n  padding-right: ", ";\n  padding-top: ", ";\n"])), LUP_SPACING_6, LUP_SPACING_7);
var RemoveButtonWrapper = styled__default['default'].div(_templateObject6$4 || (_templateObject6$4 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: ", "; \n  right: ", "; \n  height: ", "; \n  z-index: 1;\n  cursor: pointer;\n"])), LUP_SPACING_10, LUP_SPACING_10, LUP_SPACING_10);
...
var CompareCardImage = function CompareCardImage(_ref) {
  var source = _ref.source,
      ...
      height = _ref.height,
      width = _ref.width;
  return /*#__PURE__*/React__default['default'].createElement(StyledBlock, {
    style: _objectSpread2({
      position: 'relative',
      padding: '2px 0',
      height: '100%',
...
var CompareCard = function CompareCard(_ref) {
  ...
  var getExpandButton = /*#__PURE__*/React__default['default'].createElement(ExpandButtonWrapper, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
    src: ExpandSvg,
    onClick: onExpand,
  ...
  var getRemoveButton = /*#__PURE__*/React__default['default'].createElement(RemoveButtonWrapper, null, /*#__PURE__*/React__default['default'].createElement(Cross1, {
    size: LUP_SPACING_10,
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledCard, {
    ...
    if (uiSchema.uiWidget === "imageWidget") {
      ...
      }, /*#__PURE__*/React__default['default'].createElement(CompareCardImage, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], {
      key: "cardItem".concat(i)
    }, i === 0 ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
      span: showRemoveIcon ? 22 : 24
    }, /*#__PURE__*/React__default['default'].createElement(TitleText, {
      color: LUP_SECONDARY_DEEP_CYAN,
      fontWeight: LUP_MAIN_FONT_BOLD600,
      lineHeight: LUP_SPACING_16
    }, itemData[itemCardProp]))) : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
      span: isImageNext ? 21 : 24
    }, /*#__PURE__*/React__default['default'].createElement(_Tooltip__default['default'], {
      title: itemData[itemCardProp]
    }, i !== 0 && /*#__PURE__*/React__default['default'].createElement(StyledText$3, {
      fontWeight: LUP_MAIN_FONT_BOLD600,
      lineHeight: LUP_SPACING_16
    }, itemData[itemCardProp]))), isImageNext && /*#__PURE__*/React__default['default'].createElement(_Col__default['default'], {
      span: 3
    }, getExpandButton)));
  }), extras);
};
...
var StyledBlock$6 = styled__default['default'](StyledBlock)(_templateObject$A || (_templateObject$A = _taggedTemplateLiteral(["\n    height: ", ";\n    background: ", ";\n    padding: ", ";\n    align-content: center;\n"])), LUP_SPACING_110, WHITE, LUP_SPACING_8);
var StyledButton$2 = styled__default['default'](Button)(_templateObject2$i || (_templateObject2$i = _taggedTemplateLiteral(["\n    min-width: ", ";\n    display: block;\n    margin: auto;\n"])), LUP_SPACING_50);
var InputBlock = styled__default['default'](StyledBlock)(_templateObject3$d || (_templateObject3$d = _taggedTemplateLiteral(["\n    margin: auto;\n"])));
var ErrorBlock = styled__default['default'](StyledBlock)(_templateObject4$a || (_templateObject4$a = _taggedTemplateLiteral(["\n    height: ", ";\n    display: flex;\n"])), LUP_SPACING_20);
var StyledCard$1 = styled__default['default'](_Card__default['default'])(_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral(["\n    border-width: ", ";\n    padding: ", ";\n    border-style: solid;\n    border-color: ", ";\n    .ant-card-body {\n        padding: ", ";\n        width: ", ";\n        padding: ", ";\n    }\n    box-shadow: ", ";\n    min-width: ", ";\n\n"])), function (props) {
  return props.borderWidth;
}, function (props) {
...
var LabelWrapper = styled__default['default'](StyledBlock)(_templateObject$B || (_templateObject$B = _taggedTemplateLiteral(["\n  margin: ", " 0;\n"])), LUP_SPACING_2);
...
var InputField = function InputField(_ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(LabelWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledLabel, {
    error: error,
    disabled: disabled
...
var CompareItemSelector = function CompareItemSelector(_ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(InputBlock, null, /*#__PURE__*/React__default['default'].createElement(InputField, {
    label: title,
    placeholder: placeholder,
  ...
  }), /*#__PURE__*/React__default['default'].createElement(ErrorBlock, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    fontSize: LUP_MAIN_FONT_SIZE12,
    color: LUP_FUNCTIONAL_ERROR_RED,
    lineHeight: LUP_SPACING_18
  }, error))), /*#__PURE__*/React__default['default'].createElement(StyledButton$2, {
    size: "smaller",
    colored: "primary",
...
var ComparisonGrid = function ComparisonGrid(_ref) {
        ...
        onHeaderCell: function onHeaderCell() {
          return {
            ...
            render: function render() {
              return /*#__PURE__*/React__default['default'].createElement(StyledBlockBottomPadding, {
                size: LUP_SPACING_2
              }, /*#__PURE__*/React__default['default'].createElement(CompareItemSelector, {
                type: type,
                placeholder: placeholder,
                title: title,
                compareKey: compareKey,
      ...
      var column = {
        ...
        onHeaderCell: function onHeaderCell(column) {
          return {
            ...
            render: function render() {
              return /*#__PURE__*/React__default['default'].createElement(StyledBlock$4, null, /*#__PURE__*/React__default['default'].createElement(CompareCard, {
                propertiesUISchema: propertiesUISchema,
                itemCardProps: itemCardProps,
                itemData: data[item],
                extras: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null),
  ...
  return /*#__PURE__*/React__default['default'].createElement(GridWrapper, null, /*#__PURE__*/React__default['default'].createElement(TitleWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledRow$1, null, /*#__PURE__*/React__default['default'].createElement(StyledComparisonName, null, comparisonName ? "Comparison ".concat(comparisonName) : label), /*#__PURE__*/React__default['default'].createElement(StyledText$2, {
    onClick: handleClearAllData,
    disabled: clearAllDisabled
  }, ClearAll))), loading ? renderLoader(loading) : /*#__PURE__*/React__default['default'].createElement(TableWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledTable, {
    ...
    components: {
      header: {
        cell: function cell(props) {
          return /*#__PURE__*/React__default['default'].createElement(GridHeaderCell, props);
        }
      },
      body: {
        row: function row(props) {
          ...
          switch (props.rowType) {
            case "gridSectionFirstTitleRow":
              return /*#__PURE__*/React__default['default'].createElement(StyledtrTopBottomPadding, null, /*#__PURE__*/React__default['default'].createElement("td", {
              ...
              }, /*#__PURE__*/React__default['default'].createElement(StyledDiv$1, null, /*#__PURE__*/React__default['default'].createElement(StyledLabel$2, null, props.title))), Object.keys(data).length > 1 && /*#__PURE__*/React__default['default'].createElement("td", {
                className: "highlightCheckbox"
              }, /*#__PURE__*/React__default['default'].createElement(CheckboxWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledCheckbox$1, {
                onChange: function onChange(event) {
                  return onHighlightChange(event.target.checked);
                },
                checked: highlightSelected,
                subLabel: /*#__PURE__*/React__default['default'].createElement(StyledText, {
                  color: LUP_BASE_GREY_DARK
                }, highlightCheckboxLabel)
              }))));

            case "gridSectionCompareViewRow":
              return /*#__PURE__*/React__default['default'].createElement(ComparisonViewSelector, {
            ...
            case "gridSectionTitleRow":
              return /*#__PURE__*/React__default['default'].createElement(StyledtrTopBottomPadding, null, /*#__PURE__*/React__default['default'].createElement("td", {
                ...
                className: "sectionTitle"
              }, /*#__PURE__*/React__default['default'].createElement(StyledDiv$1, null, /*#__PURE__*/React__default['default'].createElement(StyledLabel$2, null, props.title))));

            default:
              return /*#__PURE__*/React__default['default'].createElement("tr", null, props.children.map(function (_ref2) {
...
var StyledBlock$7 = styled__default['default'](StyledBlock)(_templateObject$C || (_templateObject$C = _taggedTemplateLiteral(["\n    padding-top: ", ";\n    display: flex;\n    justify-content: space-around;\n"])), LUP_SPACING_13);
var StyledCheckbox$2 = styled__default['default'](Checkbox)(_templateObject2$j || (_templateObject2$j = _taggedTemplateLiteral(["\n"])));
var BodyWrapper = styled__default['default'](StyledBlock)(_templateObject3$e || (_templateObject3$e = _taggedTemplateLiteral(["\n  padding: ", " ", " ", ";\n"])), LUP_SPACING_26, LUP_SPACING_16, LUP_SPACING_18);

var _templateObject$D, _templateObject2$k, _templateObject3$f, _templateObject4$b;
var StyledModal$1 = styled__default['default'](_Modal__default['default'])(_templateObject$D || (_templateObject$D = _taggedTemplateLiteral(["\n  .ant-modal-title {\n    line-height: ", ";\n  }\n\n  .ant-modal-content {\n    box-shadow: 0 ", " ", " ", ";\n    border-radius: ", ";\n}\n\n  .ant-modal-header {\n    padding: ", " ", ";\n    padding-right: ", ";\n    background: ", ";\n    box-shadow: ", ";\n    border-bottom: ", " solid ", ";\n  }\n  .ant-modal-footer {\n    padding: 0;\n    padding-bottom: ", ";\n    text-align: center;\n    border-top: 0px;\n  }\n  .ant-modal-body {\n    padding: 0;\n  }\n\n  .ant-modal-footer button + button {\n    margin-left: 30px;\n  }\n\n  .ant-modal-close-x {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: ", ";\n    width: ", ";\n  }\n\n  border-radius: ", ";\n"])), LUP_SPACING_16, LUP_SPACING_1, LUP_SPACING_8, LUP_BASE_GREY_DARKER, LUP_SPACING_4, LUP_SPACING_14, LUP_SPACING_20, LUP_SPACING_15, LUP_BASE_GREY_LIGHTER, LUP_BOX_SHADOW_2, LUP_MAIN_BORDER_WIDTH1, LUP_BASE_GREY_LIGHTER, LUP_SPACING_40, LUP_SPACING_45, LUP_SPACING_45, LUP_MAIN_BORDER_RADIUS4);
var CloseWrapper = styled__default['default'](StyledBlock)(_templateObject2$k || (_templateObject2$k = _taggedTemplateLiteral(["\n    padding-left: ", ";\n    display: inline-block;\n"])), LUP_SPACING_15);
var StyledButton$3 = styled__default['default'](Button)(_templateObject3$f || (_templateObject3$f = _taggedTemplateLiteral(["\n  min-width: ", ";\n"])), LUP_MODAL_BUTTON_WIDTH_100);
var BodyWrapper$1 = styled__default['default'](StyledBlock)(_templateObject4$b || (_templateObject4$b = _taggedTemplateLiteral(["\n  padding: ", " ", ";\n  padding-bottom: ", ";\n"])), LUP_SPACING_30, LUP_SPACING_20, LUP_SPACING_40);
...
var ModalPopup = function ModalPopup(_ref) {
  var modalTitle = _ref.modalTitle,
      ...
      children = _ref.children;
  return /*#__PURE__*/React__default['default'].createElement(StyledModal$1, {
    title: /*#__PURE__*/React__default['default'].createElement(StyledBlock, {
      style: {
        display: 'flex',
      ...
      fontWeight: LUP_MAIN_FONT_BOLD600,
      lineHeight: LUP_SPACING_16
    }, modalTitle), /*#__PURE__*/React__default['default'].createElement(CloseWrapper, null, /*#__PURE__*/React__default['default'].createElement(Cross1, {
    ...
    centered: true,
    width: modalWidth,
    footer: [/*#__PURE__*/React__default['default'].createElement(StyledButton$3, {
      size: "small",
      colored: "secondary",
      onClick: handleCancel
    }, cancelText), /*#__PURE__*/React__default['default'].createElement(StyledButton$3, {
      size: "small",
      colored: "primary",
      onClick: handleOk
    }, okText)],
...
var SaveComparisonModal = function SaveComparisonModal(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ModalPopup, {
    modalTitle: SaveModalTitle,
    children: /*#__PURE__*/React__default['default'].createElement(BodyWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledInput, {
      placeholder: placeholder,
      value: value,
      id: "comparisonName",
      onChange: function onChange(event) {
    ...
    }), /*#__PURE__*/React__default['default'].createElement(StyledBlock$7, null, /*#__PURE__*/React__default['default'].createElement(StyledCheckbox$2, {
...
var StyledSaveText = styled__default['default'](StyledText)(_templateObject$E || (_templateObject$E = _taggedTemplateLiteral(["\n  font-size: ", ";\n  padding-right: ", ";\n  padding-left: ", ";\n  color: ", ";\n  line-height: ", ";\n"])), LUP_MAIN_FONT_SIZE14, LUP_SPACING_4, LUP_SPACING_6, LUP_BASE_BLUE_DARK, LUP_SPACING_22);
var StyledText$4 = styled__default['default'](StyledText)(_templateObject2$l || (_templateObject2$l = _taggedTemplateLiteral(["\n  font-size: ", ";\n  padding-right: ", ";\n  color: ", ";\n  line-height: ", ";\n"])), LUP_MAIN_FONT_SIZE14, LUP_SPACING_2, LUP_BASE_GREY_DARKEST, LUP_SPACING_22);
var ExportText = styled__default['default'](StyledText)(_templateObject3$g || (_templateObject3$g = _taggedTemplateLiteral(["\n  font-size: ", ";\n  padding-right: ", ";\n  color: ", ";\n  line-height: ", ";\n"])), LUP_MAIN_FONT_SIZE14, LUP_SPACING_6, LUP_BASE_GREY_DARKEST, LUP_SPACING_22);
var StyledButton$4 = styled__default['default'](Button)(_templateObject4$c || (_templateObject4$c = _taggedTemplateLiteral(["\n  width: 132px;\n  height: 32px;\n  align-self: center;\n\n  &[disabled] {\n    opacity: 1;\n    cursor: not-allowed;\n    background: ", ";\n    border-color: ", ";\n  }\n"])), LUP_BASE_GREY, LUP_BASE_GREY);
var StyledDiv$3 = styled__default['default'].div(_templateObject5$7 || (_templateObject5$7 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  cursor: pointer;\n"])));
var StyledDropDropArrow$1 = styled__default['default'].div(_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral(["\nleft: 50%;\ntransform: translateX(-50%) rotate(45deg);\ntop: -", ";\nborder-color: #fff transparent transparent #fff;\nbox-shadow: ", ";\nposition: absolute;\nz-index: 1;\ndisplay: block;\nwidth: ", ";\nheight: ", ";\nbackground: 0 0;\nborder-style: solid;\nborder-width: ", ";\n"])), LUP_SPACING_4, LUP_BOX_SHADOW_4, LUP_SPACING_12, LUP_SPACING_10, LUP_MAIN_BORDER_WIDTH6);
var StyledCol$1 = styled__default['default'](_Col__default['default'])(_templateObject7$3 || (_templateObject7$3 = _taggedTemplateLiteral(["\n  display: inline-flex;\n  align-items: center;\n"])));
var StyledFirstCol = styled__default['default'](_Col__default['default'])(_templateObject8$3 || (_templateObject8$3 = _taggedTemplateLiteral(["\n  display: inline-flex;\n  align-items: center;\n  margin-left: ", ";\n  justify-content: center;\n"])), LUP_SPACING_16);
var StyledSecondCol$1 = styled__default['default'](_Col__default['default'])(_templateObject9$1 || (_templateObject9$1 = _taggedTemplateLiteral(["\n  display: inline-flex;\n  align-items: center;\n  margin-left: ", ";\n  justify-content: center;\n"])), LUP_SPACING_30);
var StyledThirdCol = styled__default['default'](_Col__default['default'])(_templateObject10$1 || (_templateObject10$1 = _taggedTemplateLiteral(["\n  display: inline-flex;\n  align-items: center;\n  justify-content: flex-end;\n  margin-left: auto;\n  margin-right: ", ";\n"])), LUP_SPACING_16);
var StyledDivider = styled__default['default'].div(_templateObject11$1 || (_templateObject11$1 = _taggedTemplateLiteral(["\n  border: ", " solid #DDDDDD;\n  border-right: 0px;\n  margin-right: ", ";\n  height: ", ";\n"])), LUP_SPACING_1, LUP_SPACING_20, LUP_SPACING_24);
var StyledIconDiv = styled__default['default'].div(_templateObject12$1 || (_templateObject12$1 = _taggedTemplateLiteral(["\n"])));
var StyledDropDown = styled__default['default'](CustomDropDown)(_templateObject13$1 || (_templateObject13$1 = _taggedTemplateLiteral(["\n"])));
var StyledCard$2 = styled__default['default'](_Card__default['default'])(_templateObject14$1 || (_templateObject14$1 = _taggedTemplateLiteral(["\n  .ant-card-body {\n    padding: 0px;\n  }\n  padding: 0px;\n"])));
var StyledSaveIconDiv = styled__default['default'].div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  padding-top: 2px;\n"])));
var StyledMenu = styled__default['default'](_Menu__default['default'])(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\ntop: 6px;\n&.ant-dropdown-menu {\n  padding: 7px 4px 10px 4px;\n}\n.ant-dropdown-menu-item:hover, .ant-dropdown-menu-submenu-title:hover {\n  background-color: ", ";\n}\n.ant-dropdown-menu-item, .ant-dropdown-menu-submenu-title { \n  height : 32px;\n  padding: 5px 16px 5px 0px;\n}\n"])), LUP_BASE_BLUE_LIGHTEST);
var IconButtonWrapper$1 = styled__default['default'](StyledBlock)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\npadding-right: ", ";\npadding-left: ", ";\n"])), LUP_SPACING_6, LUP_SPACING_2);
...
var CompareToolBar = function CompareToolBar(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledCard$2, null, /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], {
    type: "flex",
    style: {
      padding: "9px 16px"
    }
  }, /*#__PURE__*/React__default['default'].createElement(StyledFirstCol, null, /*#__PURE__*/React__default['default'].createElement(StyledDropDown, {
    visible: isDropDownVisible,
    overlay: dropDownMenu,
    trigger: ["click"],
    placement: "bottomCenter",
    arrow: true
  }, /*#__PURE__*/React__default['default'].createElement(StyledDiv$3, null, /*#__PURE__*/React__default['default'].createElement(StyledSaveIconDiv, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
    dataTestid: "SaveSVGTestId",
    src: SaveSVG,
    style: {
      display: 'flex'
    }
  })), /*#__PURE__*/React__default['default'].createElement(StyledSaveText, null, DropDownText), /*#__PURE__*/React__default['default'].createElement(IconButton, {
  ...
  })))), /*#__PURE__*/React__default['default'].createElement(StyledSecondCol$1, null, /*#__PURE__*/React__default['default'].createElement(Button, {
    colored: "primary",
    size: "small",
    onClick: handleSaveComparison,
    disabled: saveComparisonDisabled
  }, SaveButtonText)), /*#__PURE__*/React__default['default'].createElement(StyledCol$1, null), dataLength || !deleteComparisonDisabled ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(StyledThirdCol, null, /*#__PURE__*/React__default['default'].createElement(StyledDivider, null), /*#__PURE__*/React__default['default'].createElement(StyledText$4, null, DeleteButtonText), /*#__PURE__*/React__default['default'].createElement(IconButton, {
  ...
  }))) : /*#__PURE__*/React__default['default'].createElement(StyledCol$1, {
    span: 6
  })));
};
...
var StyledModal$2 = styled__default['default'](StyledModal)(_templateObject$F || (_templateObject$F = _taggedTemplateLiteral(["\n    max-width: ", ";\n    \n    .ant-modal {\n        min-height: ", ";\n        border-radius: ", ";\n    }\n    .ant-modal-footer {\n        border-top: 0;\n    }\n\n    .ant-modal-header {\n        display: none;\n    }\n\n    .ant-modal-content {\n        border-width: ", ";\n        border-style: solid;\n        border-color: ", ";\n        width: fit-content;\n        margin: auto;\n        border-radius: ", ";\n    }\n\n    .ant-modal-close-x {\n        height: ", ";\n        width:  ", ";\n        display: contents;\n    }\n\n    .ant-modal-close-icon {\n        padding: ", ";\n    }\n\n    .ant-modal-body {\n        padding: ", ";\n        padding-right: ", ";\n        height: fit-content;\n        width: fit-content;\n        min-height: ", ";\n        display: flex;\n    }\n"])), LUP_SPACING_340, LUP_SPACING_60, LUP_MAIN_BORDER_RADIUS2, LUP_MAIN_BORDER_WIDTH2, function (props) {
  return props.color;
}, LUP_MAIN_BORDER_RADIUS2, LUP_SPACING_30, LUP_SPACING_30, LUP_SPACING_8, LUP_SPACING_15, LUP_SPACING_32, LUP_SPACING_66);
var CloseWrapper$1 = styled__default['default'](StyledBlock)(_templateObject2$m || (_templateObject2$m = _taggedTemplateLiteral(["\n    padding: ", ";\n"])), LUP_SPACING_8);
var MessageWrapper = styled__default['default'](StyledBlock)(_templateObject3$h || (_templateObject3$h = _taggedTemplateLiteral(["\n    padding-left: ", ";\n"])), LUP_SPACING_12);
var IconBlock = styled__default['default'](StyledBlock)(_templateObject4$d || (_templateObject4$d = _taggedTemplateLiteral(["\n    display: contents;\n"])));
...
var AlertPopUp = function AlertPopUp(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledModal$2, {
    visible: message,
    footer: null,
    onCancel: onCancelPopUp,
    type: type,
    centered: true,
    closeIcon: /*#__PURE__*/React__default['default'].createElement(CloseWrapper$1, null, /*#__PURE__*/React__default['default'].createElement(Cross2, {
      size: LUP_SPACING_10
    })),
  ...
  }, /*#__PURE__*/React__default['default'].createElement(StyledBlock, {
    justify: "center",
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, /*#__PURE__*/React__default['default'].createElement(IconBlock, null, type === "success" && /*#__PURE__*/React__default['default'].createElement(Image, {
    src: Confirm,
    height: LUP_SPACING_22,
    width: LUP_SPACING_22
  }), type === "error" && /*#__PURE__*/React__default['default'].createElement(Image, {
    src: Error$1,
    height: LUP_SPACING_22,
    width: LUP_SPACING_22
  })), /*#__PURE__*/React__default['default'].createElement(MessageWrapper, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    fontSize: LUP_MAIN_FONT_SIZE12,
    color: LUP_BASE_GREY_DARKER,
    lineHeight: LUP_SPACING_18
  }, message))));
...
var _templateObject$G;
var BodyWrapper$2 = styled__default['default'](StyledBlock)(_templateObject$G || (_templateObject$G = _taggedTemplateLiteral(["\n  padding: ", " ", " ", ";\n"])), LUP_SPACING_30, LUP_SPACING_20, LUP_SPACING_24);
...
var ConfirmModal = function ConfirmModal(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ModalPopup, {
    ...
    children: /*#__PURE__*/React__default['default'].createElement(BodyWrapper$2, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
...
var StyledBlock$8 = styled__default['default'](StyledBlock)(_templateObject$H || (_templateObject$H = _taggedTemplateLiteral(["\n    height: 110px;\n    background: ", ";\n    padding: ", ";\n    align-content: center;\n"])), WHITE, LUP_SPACING_8);
var StyledButton$5 = styled__default['default'](_Button__default['default'])(_templateObject2$n || (_templateObject2$n = _taggedTemplateLiteral(["\n    display: block;\n    margin: auto;\n    height: 24px;\n\n    &[disabled] {\n        cursor: not-allowed;\n    }\n\n    color: ", " !important;\n    font-size: ", ";\n    background: ", " !important;\n    border-color: ", " !important;\n\n\n    &:active, &:hover, &:focus {\n        color: ", " !important;\n        background: ", " !important;\n        border-color: ", " !important;\n    }\n\n"])), WHITE, LUP_MAIN_FONT_SIZE12, LUP_BASE_GREY, LUP_BASE_GREY, WHITE, LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_MEDIUM);
var InputBlock$1 = styled__default['default'](StyledBlock)(_templateObject3$i || (_templateObject3$i = _taggedTemplateLiteral(["\n    margin: auto;\n    min-width: ", ";\n    width: 70%;\n"])), LUP_SPACING_230);
var ErrorBlock$1 = styled__default['default'](StyledBlock)(_templateObject4$e || (_templateObject4$e = _taggedTemplateLiteral(["\n    min-height: 16px;\n"])));
var StyledDiv$4 = styled__default['default'].div(_templateObject5$8 || (_templateObject5$8 = _taggedTemplateLiteral(["\n    border: 1px dashed ", ";\n    box-sizing: border-box;\n    padding: ", " ", ";\n    background-color: ", ";\n\n    display: flex; \n    justify-content: center;\n    align-items: center;\n    height: ", ";\n    width: ", ";\n"])), LUP_BASE_GREY, LUP_SPACING_12, LUP_SPACING_6, LUP_BASE_GREY_LIGHTEST, LUP_SPACING_130, function (props) {
  return props.width || '100%';
});
var StyledInput$1 = styled__default['default'](StyledInput)(_templateObject6$6 || (_templateObject6$6 = _taggedTemplateLiteral(["\n    &[type='text'] {      \n        &:disabled {\n            border: 1px solid ", ";\n        }\n    }\n"])), LUP_FORM_DISABLED_BACKGROUND);
...
var CompareModalItemSelector = function CompareModalItemSelector(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledDiv$4, {
    compareKey: compareKey,
    width: width
  }, /*#__PURE__*/React__default['default'].createElement(InputBlock$1, null, /*#__PURE__*/React__default['default'].createElement(InputField, {
    label: title,
    placeholder: placeholder,
    onChange: function onChange(event) {
      if (event.target.value) {
  ...
  }), /*#__PURE__*/React__default['default'].createElement(ErrorBlock$1, null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
    fontSize: LUP_MAIN_FONT_SIZE12,
    color: LUP_FUNCTIONAL_ERROR_RED
  }, error))));
};
...
var StyledCol$2 = styled__default['default'](_Col__default['default'])(_templateObject$I || (_templateObject$I = _taggedTemplateLiteral(["\n  padding: 0 ", " ", " 0;\n"])), LUP_SPACING_10, LUP_SPACING_10);
var StyledContainer = styled__default['default'].div(_templateObject2$o || (_templateObject2$o = _taggedTemplateLiteral(["\n  background: ", ";\n  padding: ", " ", ";\n"])), LUP_BASE_GREY_LIGHTEST, LUP_SPACING_5, LUP_SPACING_10);
var StyledRow$3 = styled__default['default'](_Row__default['default'])(_templateObject3$j || (_templateObject3$j = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: flex-start;\n  flex-wrap: wrap;\n"])));
var StyledSecondRow$1 = styled__default['default'](_Row__default['default'])(_templateObject4$f || (_templateObject4$f = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  align-items: center;\n"])));
var StyledText$5 = styled__default['default'](StyledText)(_templateObject5$9 || (_templateObject5$9 = _taggedTemplateLiteral(["\n  flex-grow: 1;\n"])));
var StyledSecondText = styled__default['default'](StyledText)(_templateObject6$7 || (_templateObject6$7 = _taggedTemplateLiteral(["\n  cursor: pointer;\n"])));
var StyledModal$3 = styled__default['default'](StyledModal)(_templateObject7$4 || (_templateObject7$4 = _taggedTemplateLiteral(["\n\n  padding-top: ", ";\n  padding-bottom: ", " !important;\n  background: transparent !important;\n\n  .ant-modal-centered .ant-modal {\n    background: transparent;\n  }\n\n  background: ", ";\n  padding-bottom: 0px;\n\n  .ant-modal-content {\n    box-shadow: ", ";\n  }\n\n  .ant-modal-title {\n    line-height: ", ";\n    font-weight: ", ";\n    color: ", ";\n  }\n\n  .ant-modal-header {\n    padding: ", ";\n    padding-top: ", ";\n    background: ", ";\n    border-radius: 0;\n    border: none;\n  }\n  .ant-modal-footer {\n    background: ", ";\n    text-align: center;\n    border-top: 0px;\n    padding: 0;\n  }\n  .ant-modal-body {\n    padding: ", " ", " ", " ", ";\n    padding-top: 0;\n    background: ", ";\n  }\n  .ant-btn {\n    padding: 0px;\n    width: ", ";\n    height: ", ";\n    font-size: ", ";\n  }\n  .ant-modal-footer button + button {\n    margin-left: ", ";\n  }\n\n  .ant-modal-close-x {\n    position: absolute;\n    right: 0px;\n    bottom: 0px;\n    color: ", ";\n    width: ", ";\n    height: ", ";\n  }\n"])), LUP_SPACING_100, LUP_SPACING_100, LUP_BASE_GREY_LIGHTEST, LUP_BOX_SHADOW_3, LUP_SPACING_20, LUP_MAIN_FONT_BOLD600, LUP_BASE_GREY_DARKEST, LUP_SPACING_20, LUP_SPACING_7, LUP_BASE_GREY_LIGHTEST, LUP_BASE_GREY_LIGHTEST, LUP_SPACING_30, LUP_SPACING_10, LUP_SPACING_22, LUP_SPACING_20, LUP_BASE_GREY_LIGHTEST, LUP_SPACING_100, LUP_SPACING_32, LUP_SPACING_12, LUP_SPACING_30, WHITE, LUP_SPACING_24, LUP_SPACING_40);
var StyledCard$3 = styled__default['default'](_Card__default['default'])(_templateObject8$4 || (_templateObject8$4 = _taggedTemplateLiteral(["\n  .ant-card-body {\n    padding: 0px;\n  }\n"])));
...
var CompareViewModal = function CompareViewModal(_ref) {
  var products = _ref.products,
      ...
      inputValueForError = _ref.inputValueForError,
      comparisonDataError = _ref.comparisonDataError;
  return /*#__PURE__*/React__default['default'].createElement(StyledModal$3, {
    visible: visible,
    title: "Product Viewer",
    onCancel: handleCancel,
    footer: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null),
    width: "88%",
    centered: true,
    closeIcon: /*#__PURE__*/React__default['default'].createElement(Cross3, {
      size: LUP_SPACING_24,
      onClick: handleCancel
    }),
    maskStyle: {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(StyledRow$3, null, selectedProducts.map(function (product) {
    return products[product] && /*#__PURE__*/React__default['default'].createElement(StyledCol$2, {
      id: product,
      span: 8
    }, /*#__PURE__*/React__default['default'].createElement(StyledCard$3, null, /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], {
      style: {
        height: '76vh',
        maxHeight: '454px'
      }
      ...
      height: "auto",
      width: "auto"
    })), /*#__PURE__*/React__default['default'].createElement(StyledContainer, null, /*#__PURE__*/React__default['default'].createElement(StyledSecondRow$1, null, /*#__PURE__*/React__default['default'].createElement(StyledText$5, {
      fontWeight: LUP_MAIN_FONT_BOLD600,
      fontSize: LUP_MAIN_FONT_SIZE14,
      lineHeight: "16px",
      color: LUP_SECONDARY_DEEP_CYAN
    }, products[product]['product identifier']), /*#__PURE__*/React__default['default'].createElement(StyledSecondText, {
      fontSize: LUP_MAIN_FONT_SIZE14,
      lineHeight: "22px",
      color: LUP_BASE_BLUE_DARK,
    ...
    }, "Remove")), /*#__PURE__*/React__default['default'].createElement(_Row__default['default'], null, /*#__PURE__*/React__default['default'].createElement(StyledText, {
      fontWeight: LUP_MAIN_FONT_BOLD600,
      fontSize: LUP_MAIN_FONT_SIZE14,
      lineHeight: "16px"
    }, products[product]['product name'])))));
  }), /*#__PURE__*/React__default['default'].createElement(StyledCol$2, {
    id: "itemSelector",
    span: 8,
    style: {
      minHeight: '100px'
    }
  }, loadingInModal ? /*#__PURE__*/React__default['default'].createElement(Spinner, {
    style: {
      position: 'absolute',
      marginTop: '25%',
      left: '50%'
    }
  }) : /*#__PURE__*/React__default['default'].createElement(CompareModalItemSelector, {
...
var _templateObject$J, _templateObject2$p, _templateObject3$k, _templateObject4$g, _templateObject5$a, _templateObject6$8, _templateObject7$5;
var CheckboxGroup = _Checkbox__default['default'].Group;
var VerticalCheckboxGroup = styled__default['default'](CheckboxGroup)(_templateObject$J || (_templateObject$J = _taggedTemplateLiteral(["\nmargin-top: ", ";\nbackground: transparent;\n\n.ant-checkbox-wrapper {\n  display: flex;\n  flex-flow: row nowrap;\n  align-items: center;\n  justify-content: flex-start;\n  font-size: ", ";\n  color: ", ";\n  line-height: ", ";\n}\n\n.ant-checkbox {\n  margin: auto 0;\n  border: ", " solid ", ";\n  border-radius: ", ";\n  height: ", ";\n  width: ", ";\n\n  & + span {\n    transition: 0.4s;\n    padding-left: ", ";\n    padding-right: ", ";\n    color: ", ";\n  }\n\n  &:hover {\n    border-color: ", ";\n  }\n\n  &.ant-checkbox-checked {\n    border-color: ", " !important;\n    background-color: ", " !important;\n  }\n\n  &.ant-checkbox-checked > span.ant-checkbox-inner {\n    background-color: ", " !important;\n  }\n\n  &.ant-checkbox-indeterminate .ant-checkbox-inner {\n    background-color: transparent;\n    border-color: ", " !important;\n\n    &:after {\n      content: ' ';\n      transform: scale(1);\n      position: absolute;\n      left: ", ";\n      top: ", ";\n      width: ", ";\n      height: ", ";\n    }\n  }\n\n  &.ant-checkbox-checked .ant-checkbox-inner:after,\n  & .ant-checkbox-inner:after {\n    left: ", ";\n    top: ", ";\n    width: ", ";\n    height: ", ";\n    border-color: ", ";\n  }\n\n  &.ant-checkbox-disabled .ant-checkbox-inner:after {\n    border-color: ", ";\n  }\n}\n\n.ant-checkbox-inner {\n  width: ", ";\n  height: ", ";\n  border: none;\n  border-color: ", ";\n\n  &:hover {\n    border: none;\n  }\n}\n.ant-checkbox-checked {\n  border-color: ", " !important;\n\n  & .ant-checkbox-inner {\n    background-color: ", ";\n    border-color: ", " !important;\n    border-radius: 0;\n  }\n\n  & + span {\n    color: ", ";\n  }\n\n  &:after {\n    border-color: transparent;\n    border: none;\n  }\n}\n\n.ant-checkbox-disabled {\n  border-color: ", " !important;\n  background: ", ";\n  & .ant-checkbox-inner {\n    border-color: ", " !important;\n    background-color: ", ";\n  }\n\n  & + span  {\n    color: ", ";\n  }\n\n  &.ant-checkbox-checked + span > span  {\n    color: ", " !important;\n  }\n\n  &.ant-checkbox-checked {\n    border-color: ", " !important;\n    background-color: ", " !important;\n  }\n\n  &.ant-checkbox-checked + span.ant-checkbox-inner {\n    border-radius: 0;\n    border-color: ", " !important;\n    background-color: ", " !important;    }\n}\n\n  &.ant-checkbox-wrapper:hover .ant-checkbox-inner,\n  & .ant-checkbox:hover .ant-checkbox-inner {\n    border-color: transparent;\n  }\n\n  & .ant-checkbox-input:focus + .ant-checkbox-inner {\n    border-color: ", ";\n  }\n\n  .ant-checkbox-group-item {\n    display: block;\n    margin-right: 0;\n    margin-bottom: ", ";\n    text-transform: capitalize;\n    padding-left: ", ";\n  }\n  .ant-checkbox-inner {\n    border-radius: 0px;\n  }\n"])), LUP_SPACING_6, LUP_MAIN_FONT_SIZE14, LUP_BASE_GREY_DARKEST, LUP_SPACING_22, LUP_MAIN_BORDER_WIDTH1, LUP_BASE_GREY_MEDIUM, LUP_MAIN_BORDER_WIDTH1, LUP_SPACING_12, LUP_SPACING_12, LUP_SPACING_6, LUP_SPACING_6, LUP_BASE_GREY_DARK, LUP_BASE_BLUE, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARK, LUP_BASE_BLUE_DARK, LUP_BASE_GREY, LUP_SPACING_2, LUP_SPACING_4, LUP_SPACING_6, LUP_SPACING_2, LUP_SPACING_2, LUP_SPACING_5, LUP_SPACING_4, LUP_SPACING_7, WHITE, WHITE, LUP_SPACING_10, LUP_SPACING_10, WHITE, LUP_BASE_BLUE, LUP_BASE_BLUE, WHITE, LUP_BASE_GREY_DARKEST, LUP_BASE_GREY, LUP_BASE_GREY_LIGHTER, LUP_BASE_GREY, LUP_BASE_GREY_LIGHTER, LUP_BASE_GREY, LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_MEDIUM, LUP_BASE_GREY_MEDIUM, LUP_BASE_BLUE, LUP_SPACING_4, LUP_SPACING_18);
var StyledMenu$1 = styled__default['default'](_Menu__default['default'])(_templateObject2$p || (_templateObject2$p = _taggedTemplateLiteral(["\n  .ant-menu-item-selected {\n    background-color: transparent !important;\n  }  \n\n  .ant-menu-submenu {\n    background-color: transparent !important;\n  } \n  \n  .ant-menu-submenu > .ant-menu {\n    background-color: transparent !important;\n  }\n\n  .ant-menu-item::after {\n    border-right: none;\n  }\n\n  .ant-menu-item {\n    height: ", ";\n    padding: 0 !important;\n    margin-top: 0;\n\n    &:active {\n      background: transparent;\n    }\n  }\n\n  .ant-menu-item::after {\n    border-right: none;\n  }\n\n  .ant-menu-inline {\n    border-right: 0;\n  }\n\n  .ant-menu-inline .ant-menu-item {\n    height: auto;\n    background: ", ";\n    margin: 0;\n  }\n\n  .ant-menu-item-group-title {\n    padding: 0;\n  }\n\n  .ant-menu-submenu-title {\n    padding: 0 !important;\n    padding-bottom: ", " !important;\n    height: ", " !important;\n  }\n\n  .ant-menu-submenu-arrow {\n    right: 0 !important;\n  }\n\n  .ant-menu-submenu-title {\n    & {\n      .ant-menu-submenu-arrow::before, .ant-menu-submenu-arrow::after {\n          background: ", " !important;\n      }\n    }\n  }\n\n  .ant-menu-submenu {\n    margin-bottom: ", ";\n  }\n\n  .ant-menu-item-selected {\n    border: none;\n  }\n"])), LUP_SPACING_30, LUP_BASE_GREY_LIGHTEST, LUP_SPACING_5, LUP_SPACING_21, LUP_BASE_BLUE_DARK, LUP_SPACING_20);
var FlexSpaceBetween = styled__default['default'].div(_templateObject3$k || (_templateObject3$k = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n"])));
var FlexContentCenter = styled__default['default'].div(_templateObject4$g || (_templateObject4$g = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  align-content: center;\n"])));
var StyledFilterPanelHeading = styled__default['default'](StyledMenu$1.Item)(_templateObject5$a || (_templateObject5$a = _taggedTemplateLiteral(["\n  color: #444444;\n  font-weight: ", ";\n  font-size: ", ";\n  line-height: ", ";\n  min-width: ", ";\n"])), LUP_MAIN_FONT_BOLD600, LUP_SPACING_16, LUP_SPACING_24, LUP_SPACING_86);
var StyledLink$1 = styled__default['default'](StyledText)(_templateObject6$8 || (_templateObject6$8 = _taggedTemplateLiteral(["\n  color: ", ";\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  font-weight: normal;\n  font-size: ", ";\n  line-height: ", ";\n  padding-top: ", ";\n  float: right;\n"])), LUP_BASE_BLUE_DARK, LUP_MAIN_FONT_SIZE14, LUP_SPACING_22, LUP_SPACING_2);
var StyledSubMenuLabel = styled__default['default'].span(_templateObject7$5 || (_templateObject7$5 = _taggedTemplateLiteral(["\n  line-height: ", ";\n  color: ", ";\n  padding-left: ", ";\n"])), LUP_SPACING_16, LUP_BASE_GREY_DARKEST, LUP_SPACING_6);

var SubMenu = StyledMenu$1.SubMenu;

var FilterPanel = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(FilterPanel, [{
    key: "handleClearAll",
    value: function handleClearAll(ev) {
      var _this$props = this.props,
          updateSelectedProperties = _this$props.updateSelectedProperties,
          initialSelectedProperties = _this$props.initialSelectedProperties;
    ...
    value: function handleChange(value, key) {
      var _this$props2 = this.props,
          updateSelectedProperties = _this$props2.updateSelectedProperties,
          selectedProperties = _this$props2.selectedProperties;
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(StyledMenu$1, {
        ...
        mode: "inline"
      }, /*#__PURE__*/React__default['default'].createElement(StyledMenu$1.Item, null, /*#__PURE__*/React__default['default'].createElement(FlexSpaceBetween, null, /*#__PURE__*/React__default['default'].createElement(StyledFilterPanelHeading, null, "Compare"), this.props.filters.length > 0 && /*#__PURE__*/React__default['default'].createElement(StyledLink$1, {
        onClick: this.handleClearAll
      }, ResetFilter))), this.props.filters.length === 0 && /*#__PURE__*/React__default['default'].createElement(StyledMenu$1.Item, null, /*#__PURE__*/React__default['default'].createElement(FlexContentCenter, null, "No filters available")), this.props.filters.map(function (filter, i) {
        return /*#__PURE__*/React__default['default'].createElement(SubMenu, {
          key: "sub".concat(i),
          title: /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(Checkbox, {
            indeterminate: _this2.props.selectedProperties && _this2.props.selectedProperties[filter.key] && !!_this2.props.selectedProperties[filter.key].length && _this2.props.selectedProperties[filter.key].length < filter.options.length,
            checked: _this2.props.selectedProperties && _this2.props.selectedProperties[filter.key] && _this2.props.selectedProperties[filter.key].length === filter.options.length,
            onChange: function onChange(e) {
              return e.target.checked ? _this2.handleChange(filter.options, filter.key) : _this2.handleChange([], filter.key);
            },
            label: filter.title
          }))
        }, /*#__PURE__*/React__default['default'].createElement(StyledMenu$1.ItemGroup, {
          key: "g".concat(i)
        }, /*#__PURE__*/React__default['default'].createElement(StyledMenu$1.Item, {
          key: "gi".concat(i)
        }, /*#__PURE__*/React__default['default'].createElement(VerticalCheckboxGroup, {
          options: filter.options,
          value: filter.value,
          onChange: function onChange(values) {
            return _this2.handleChange(values, filter.key);
          }
        }))));
      }));
    }
...
var _templateObject$K, _templateObject2$q, _templateObject3$l, _templateObject4$h, _templateObject5$b, _templateObject6$9, _templateObject7$6, _templateObject8$5;
var StyledWrapper$2 = styled__default['default'].div(_templateObject$K || (_templateObject$K = _taggedTemplateLiteral(["\n  background: ", ";\n  display: flex;\n  flex-direction: column;\n  min-height: 100vh;\n  height: fit-content;\n"])), LUP_BASE_GREY_LIGHTER);
var StyledDiv$5 = styled__default['default'].div(_templateObject2$q || (_templateObject2$q = _taggedTemplateLiteral(["\n  display: flex;\n  flex-grow: 1;\n"])));
var StyledBlock$9 = styled__default['default'](StyledBlock)(_templateObject3$l || (_templateObject3$l = _taggedTemplateLiteral(["\n  background: ", ";\n  margin: ", " ", ";\n  padding-right: ", ";\n  padding-top: ", ";\n\n  flex-direction: column;\n  display: flex;\n  position: relative;\n  overflow-x: hidden;\n  width: 100%;\n  box-shadow:", ";\n"])), LUP_BASE_GREY_LIGHTEST, LUP_SPACING_15, LUP_SPACING_10, LUP_SPACING_20, LUP_SPACING_7, LUP_BOX_SHADOW_7);
var FilterBlock = styled__default['default'](StyledBlock)(_templateObject4$h || (_templateObject4$h = _taggedTemplateLiteral(["\n  background: ", ";\n  margin: ", " ", ";\n  padding: ", ";\n  width: 20%;\n  min-width: ", ";\n\n  flex-direction: column;\n  display: flex;\n  position: relative;\n  box-shadow:", ";\n"])), LUP_BASE_GREY_LIGHTEST, LUP_SPACING_15, LUP_SPACING_10, LUP_SPACING_20, LUP_SPACING_216, LUP_BOX_SHADOW_7);
var StyledDropDropArrow$2 = styled__default['default'].div(_templateObject5$b || (_templateObject5$b = _taggedTemplateLiteral(["\nleft: 50%;\ntransform: translateX(-50%) rotate(45deg);\ntop: -", ";\nborder-color: ", " transparent transparent ", ";\nbox-shadow: ", ";\nposition: absolute;\nz-index: 1;\ndisplay: block;\nwidth: ", ";\nheight: ", ";\nbackground: 0 0;\nborder-style: solid;\nborder-width: ", ";\n"])), LUP_SPACING_4, WHITE, WHITE, LUP_BOX_SHADOW_4, LUP_SPACING_12, LUP_SPACING_10, LUP_MAIN_BORDER_WIDTH6);
var ToolbarWrapper = styled__default['default'].div(_templateObject6$9 || (_templateObject6$9 = _taggedTemplateLiteral(["\n  box-shadow: ", ";\n"])), LUP_BOX_SHADOW_6);
var StyledMenu$2 = styled__default['default'](_Menu__default['default'])(_templateObject7$6 || (_templateObject7$6 = _taggedTemplateLiteral(["\ntop: 6px;\n&.ant-dropdown-menu {\n  padding: 7px 4px 10px 4px;\n}\n.ant-dropdown-menu-item:hover, .ant-dropdown-menu-submenu-title:hover {\n  background-color: ", ";\n}\n.ant-dropdown-menu-item, .ant-dropdown-menu-submenu-title { \n  height : 32px;\n  padding: 5px 16px 5px 0px;\n}\n"])), LUP_BASE_BLUE_LIGHTEST);
var IconButtonWrapper$2 = styled__default['default'](StyledBlock)(_templateObject8$5 || (_templateObject8$5 = _taggedTemplateLiteral(["\npadding-right: ", ";\npadding-left: ", ";\n"])), LUP_SPACING_6, LUP_SPACING_2);

var dropDownCheck = "data:image/svg+xml,%3Csvg%20width%3D%228%22%20height%3D%2210%22%20viewBox%3D%220%200%208%2010%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M3%205.59009L1.70711%204.29289C1.31658%203.90237%200.683418%203.90237%200.292893%204.29289C-0.0976311%204.68342%20-0.0976311%205.31658%200.292893%205.70711L3%208.41421L7.70711%203.70711C8.09763%203.31658%208.09763%202.68342%207.70711%202.29289C7.31658%201.90237%206.68342%201.90237%206.29289%202.29289L3%205.59009Z%22%20fill%3D%22%230076BF%22%2F%3E%3C%2Fsvg%3E";

var Item = StyledMenu$2.Item;

var Compare = function Compare(_ref) {
  var comparisonPanelProps = _ref.comparisonPanelProps,
      properties = _ref.properties,
      data = _ref.data,
      dataForCompareModal = _ref.dataForCompareModal,
      primary = _ref.primary,
      compareKey = _ref.compareKey,
      onSubmit = _ref.onSubmit,
      onSubmitFromModal = _ref.onSubmitFromModal,
      onClickViewComparison = _ref.onClickViewComparison,
      templateName = _ref.templateName,
      selectedProducts = _ref.selectedProducts,
      updateSelectedProducts = _ref.updateSelectedProducts,
      selectedProductsFromModal = _ref.selectedProductsFromModal,
      updateSelectedProductsFromModal = _ref.updateSelectedProductsFromModal,
      selectedProperties = _ref.selectedProperties,
      updateSelectedProperties = _ref.updateSelectedProperties,
      saveComparison = _ref.saveComparison,
      saveComparisonDisabled = _ref.saveComparisonDisabled,
      alertSuccessMsg = _ref.alertSuccessMsg,
      alertErrorMsg = _ref.alertErrorMsg,
      closeComparisonNotification = _ref.closeComparisonNotification,
      defaultComparisonName = _ref.defaultComparisonName,
      propertiesUISchema = _ref.propertiesUISchema,
      itemCardProps = _ref.itemCardProps,
      currentComparisonId = _ref.currentComparisonId,
      comparisonDataError = _ref.comparisonDataError,
      currentItemKey = _ref.currentItemKey,
      deleteCurrentComparison = _ref.deleteCurrentComparison,
      deleteComparisonDisabled = _ref.deleteComparisonDisabled,
      savedComparisons = _ref.savedComparisons,
      savedComparisonKeys = _ref.savedComparisonKeys,
      saveCurrentComparisonId = _ref.saveCurrentComparisonId,
      itemSelectorProp = _ref.itemSelectorProp,
      itemsToCompareCount = _ref.itemsToCompareCount,
      removeCompareItem = _ref.removeCompareItem,
      onHighlightChange = _ref.onHighlightChange,
      ...
      handleClearAllData = _ref.handleClearAllData,
      loadingInModal = _ref.loadingInModal,
      compareViewVisible = _ref.compareViewVisible,
      setCompareViewVisible = _ref.setCompareViewVisible,
      handleCompareViewCancel = _ref.handleCompareViewCancel,
      initialSelectedProperties = _ref.initialSelectedProperties,
      loading = _ref.loading,
      renderLoader = _ref.renderLoader,
      inputValueForError = _ref.inputValueForError;
  var keys = Object.keys(comparisonPanelProps);

  var _useState = React.useState(false),
      _useState2 = _slicedToArray(_useState, 2),
      saveModalVisible = _useState2[0],
      setSaveModalVisible = _useState2[1];

  var _useState3 = React.useState(false),
      _useState4 = _slicedToArray(_useState3, 2),
      deleteConfirmModalVisible = _useState4[0],
      setDeleteConfirmModalVisible = _useState4[1];

  var filters = keys.map(function (filterKey) {
    return {
      'key': filterKey,
  ...
  var handleDropdownClick = function handleDropdownClick(item) {
    saveCurrentComparisonId(item.key);
  };

  var onSubmitAndUpdate = function onSubmitAndUpdate(value, key, product) {
    onSubmitFromModal(value, key, product);
  };

  var getComparisonsDropdown = function getComparisonsDropdown() {
    return /*#__PURE__*/React__default['default'].createElement(StyledMenu$2, {
      onClick: handleDropdownClick
    }, /*#__PURE__*/React__default['default'].createElement(StyledDropDropArrow$2, null), savedComparisons.length > 0 ? savedComparisons.map(function (savedComparison) {
      return /*#__PURE__*/React__default['default'].createElement(Item, {
        key: savedComparison.id,
        onClick: function onClick() {
          return onClickViewComparison(savedComparison.id);
        }
        ...
        key: savedComparison.id
      }, savedComparison.id === currentComparisonId ? /*#__PURE__*/React__default['default'].createElement(IconButtonWrapper$2, null, /*#__PURE__*/React__default['default'].createElement(IconButton, {
        src: dropDownCheck,
        size: "8px"
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledWrapper$2, null, /*#__PURE__*/React__default['default'].createElement(ToolbarWrapper, null, /*#__PURE__*/React__default['default'].createElement(CompareToolBar, {
    ...
    dropDownMenu: function dropDownMenu() {
      return getComparisonsDropdown();
    },
    isDropDownVisible: savedComparisons.length,
    deleteComparisonDisabled: deleteComparisonDisabled,
    handleDeleteComparison: function handleDeleteComparison() {
      return setDeleteConfirmModalVisible(true);
    },
    handleDropDown: onClickViewComparison,
    dataLength: Object.keys(data).length
  })), /*#__PURE__*/React__default['default'].createElement(StyledDiv$5, null, /*#__PURE__*/React__default['default'].createElement(FilterBlock, null, /*#__PURE__*/React__default['default'].createElement(FilterPanel, {
    filters: filters,
    updateSelectedProperties: updateSelectedProperties,
    selectedProperties: selectedProperties,
    initialSelectedProperties: initialSelectedProperties
  })), /*#__PURE__*/React__default['default'].createElement(StyledBlock$9, null, /*#__PURE__*/React__default['default'].createElement(ComparisonGrid, {
    sections: sections,
    primary: primary,
    ...
    label: templateName,
    onClickSubmit: function onClickSubmit() {
      return setCompareViewVisible(true);
    },
    selectedProducts: selectedProducts,
    updateSelectedProducts: updateSelectedProducts,
    propertiesUISchema: propertiesUISchema,
  ...
  }))), /*#__PURE__*/React__default['default'].createElement(CompareViewModal, {
    ...
    compareKey: compareKey,
    handleRemove: function handleRemove(productToRemove) {
      return updateSelectedProductsFromModal(selectedProductsFromModal.filter(function (sProduct) {
        return sProduct !== productToRemove;
      }));
    },
    handleCancel: handleCompareViewCancel,
    inputValueForError: inputValueForError,
    comparisonDataError: comparisonDataError
  }), /*#__PURE__*/React__default['default'].createElement(SaveComparisonModal, {
    type: "string",
    placeholder: "Save Comparison as",
    ...
    itemSelectorProp: itemSelectorProp
  }), alertSuccessMsg && /*#__PURE__*/React__default['default'].createElement(AlertPopUp, {
    type: "success",
    message: alertSuccessMsg,
    onCancelPopUp: closeComparisonNotification
  }), alertErrorMsg && /*#__PURE__*/React__default['default'].createElement(AlertPopUp, {
    type: "error",
    message: alertErrorMsg,
    onCancelPopUp: closeComparisonNotification
  }), !deleteComparisonDisabled && /*#__PURE__*/React__default['default'].createElement(ConfirmModal, {
    ...
    handleCancel: function handleCancel() {
      return setDeleteConfirmModalVisible(false);
    },
    okText: "DELETE",
...
Compare.defaultProps = {
  savedComparisons: [],
  saveCurrentComparisonId: function saveCurrentComparisonId() {},
  itemsToCompareCount: 4,
  removeCompareItem: function removeCompareItem() {},
  inputValueForError: ''
};

var CompareContainer = function CompareContainer(_ref) {
  var compareKey = _ref.compareKey,
  ...
  var _useContext = React.useContext(CompareContext),
      _useContext2 = _slicedToArray(_useContext, 3),
      state = _useContext2[0],
      dispatch = _useContext2[1],
      compareAction = _useContext2[2]; // update templateId when component mounts
  ...
  React.useEffect(function () {}, [state.currentComparisonId]);

  var onSubmit = function onSubmit(value, key) {
    dispatch({
    ...
    if (typeof fetchData === "function") {
      var nextKey = key.split('_');
      nextKey[1] = parseInt(nextKey[1]) + 1;
      nextKey = nextKey.join('_');
      fetchData(value).then(function (_ref2) {
        var url = _ref2.url,
            data = _ref2.data;
        ...
        dispatch({
          ...
          apiUrls: newState.apiUrls,
          values: newState.values,
          compareModalValues: newState.compareModalValues,
          nextItemKey: nextKey
        });
      ...
      var url = "".concat(state.apiUrls[key] || state.apiUrl);
      compareAction.getComparisonData(url, key, transformResponse);
    }

    var selectedItems = state.selectedItems;
    var newSelectedItems = [].concat(_toConsumableArray(selectedItems), [key]);
    dispatch({
      type: SET_COMPARISON_DATA,
      name: state.name,
  ...
  var onSubmitFromModal = function onSubmitFromModal(value, key, product) {
    dispatch({
      type: GET_COMPARISON_MODAL_DATA,
      loadingInModal: true,
      currentItemKey: key
    });
    ...
    if (typeof fetchData === "function") {
      ...
      nextKey[1] = parseInt(nextKey[1]) + 1;
      nextKey = nextKey.join('_');
      fetchData(value).then(function (_ref3) {
        var url = _ref3.url,
            data = _ref3.data;
        ...
        dispatch({
          type: GET_COMPARISON_MODAL_DATA_SUCCESS,
          apiUrls: newState.apiUrls,
          compareModalValues: newState.compareModalValues,
          nextItemKey: nextKey,
          selectedProductsFromModal: newState.selectedProductsFromModal,
          inputValue: value
        });
      }).catch(function (error) {
        dispatch({
          type: GET_COMPARISON_MODAL_DATA_FAILED,
          comparisonDataError: error.message,
          currentItemKey: key,
          inputValue: value
        });
  ...
  var onClickViewComparison = function onClickViewComparison(comparisonId) {
    dispatch({
      type: GET_COMPARISON_DATA,
      loading: true,
      isComparisonChanged: false
  ...
  var renderError = function renderError(error) {
    if (error) {
      return /*#__PURE__*/React__default['default'].createElement("h1", null, "Error...");
    }
  };

  var saveComparison = function saveComparison(name) {
    dispatch({
  ...
  var updateSelectedProperties = function updateSelectedProperties(selectedProperties) {
    dispatch({
      type: UPDATE_SELECTED_PROPERTIES,
      selectedProperties: selectedProperties,
      propertiesUpdated: JSON.stringify(selectedProperties) !== JSON.stringify(state.initialSelectedProperties)
    });
  };

  var updateSelectedProducts = function updateSelectedProducts(selectedProducts) {
    dispatch({
      type: UPDATE_SELECTED_PRODUCTS,
      selectedProducts: selectedProducts,
      selectedProductsFromModal: JSON.parse(JSON.stringify(selectedProducts))
    });
  };

  var updateSelectedProductsFromModal = function updateSelectedProductsFromModal(selectedProductsFromModal) {
    dispatch({
      type: UPDATE_SELECTED_PRODUCTS_FROM_MODAL,
      selectedProductsFromModal: selectedProductsFromModal
    });
  };

  var handleCompareViewCancel = function handleCompareViewCancel() {
    var nextKey = "".concat(compareKey, "_").concat(Object.keys(state.values).length + 1);
    dispatch({
      type: COMPARE_VIEW_CANCEL,
      compareModalValues: JSON.parse(JSON.stringify(state.values)),
      currentItemKey: nextKey,
      selectedProductsFromModal: JSON.parse(JSON.stringify(state.selectedProducts))
    });
  };

  var setCompareViewVisible = function setCompareViewVisible(compareViewVisible) {
    dispatch({
      type: SET_COMPARE_VIEW_VISIBLE,
      compareViewVisible: compareViewVisible
    });
  };

  var getDefaultComparisonName = function getDefaultComparisonName() {
    var values = state.values,
        itemSelectorProp = state.itemSelectorProp;
    var keys = Object.keys(values);

    if (values && keys.length) {
      var firstProduct = values[keys[0]];
      var itemSelector = itemSelectorProp.title && itemSelectorProp.title.toLowerCase();
      return firstProduct[itemSelector];
    }
  };

  var handleClearAllData = function handleClearAllData() {
    dispatch({
      type: CLEAR_COMPARISON_DATA
    });
  };

  var deleteCurrentComparison = function deleteCurrentComparison() {
    var currentComparisonId = state.currentComparisonId;
    dispatch({
  ...
  var saveCurrentComparisonId = function saveCurrentComparisonId(id) {
    var currentComparisonName = state.savedComparisonKeys && state.savedComparisonKeys[id].name;
    dispatch({
      type: SAVE_CURRENT_COMPARISON_ID,
      currentComparisonId: id,
      name: currentComparisonName
    });
  };

  var removeCompareItem = function removeCompareItem(itemKey) {
    var values = state.values,
        selectedProducts = state.selectedProducts,
        selectedProductsFromModal = state.selectedProductsFromModal; // delete values[itemKey];

    while (itemKey && values[itemKey]) {
      var nextKey = itemKey.split('_');
      nextKey[1] = parseInt(nextKey[1]) + 1;
      nextKey = nextKey.join('_');
    ...
    var newSelectedProductsFromModal = selectedProductsFromModal.filter(function (product) {
      return product !== itemKey;
    });
    dispatch({
      ...
      selectedProductsFromModal: newSelectedProductsFromModal,
      selectedProducts: newSelectedProducts
    });
  };

  var onHighlightChange = function onHighlightChange(value) {
    dispatch({
      type: HIGHLIGHT_DIFFERENCES,
      highlightSelected: value
    });
  }; //render compare 


  var renderCompare = function renderCompare(properties) {
    if (Object.keys(properties).length > 0) {
      return /*#__PURE__*/React__default['default'].createElement(Compare, {
        comparisonPanelProps: state.comparisonPanelProps,
        properties: properties,
        primary: "IAN_1",
        data: _objectSpread2({}, state.values),
        dataForCompareModal: _objectSpread2({}, state.compareModalValues),
        compareKey: compareKey,
        onSubmit: onSubmit,
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, state.initialLoading === true ? renderLoader(state.initialLoading) : renderCompare(state.properties), renderError(state.error));
};
...
var Compare$1 = function Compare(_ref) {
  var compareKey = _ref.compareKey,
      authKey = _ref.authKey,
      apiUrl = _ref.apiUrl,
      fetchData = _ref.fetchData,
      transformResponse = _ref.transformResponse,
      templateId = _ref.templateId;
  return /*#__PURE__*/React__default['default'].createElement(styled$4.ThemeProvider, {
    theme: theme
  }, /*#__PURE__*/React__default['default'].createElement(CompareContextProvider, null, /*#__PURE__*/React__default['default'].createElement(CompareContainer, {
    compareKey: compareKey,
    authKey: authKey,
    apiUrl: apiUrl,
    fetchData: fetchData,
